...
class PracticeResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'xero_partner_since' => 'int''tier' => 'string''location' => 'string''organisation_count' => 'int''staff_certified' => 'bool'
    ];
    ...
    protected static $openAPIFormats = [
        'xero_partner_since' => 'int32''tier' => null'location' => null'organisation_count' => 'int32''staff_certified' => null
    ];
    ...
    protected static $attributeMap = [
        'xero_partner_since' => 'xeroPartnerSince''tier' => 'tier''location' => 'location''organisation_count' => 'organisationCount''staff_certified' => 'staffCertified'
    ];
    ...
    protected static $setters = [
        'xero_partner_since' => 'setXeroPartnerSince''tier' => 'setTier''location' => 'setLocation''organisation_count' => 'setOrganisationCount''staff_certified' => 'setStaffCertified'
    ];
    ...
    protected static $getters = [
        'xero_partner_since' => 'getXeroPartnerSince''tier' => 'getTier''location' => 'getLocation''organisation_count' => 'getOrganisationCount''staff_certified' => 'getStaffCertified'
    ];

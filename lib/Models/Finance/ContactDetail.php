...
class ContactDetail implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'contact_id' => 'string''name' => 'string''total' => 'double''total_detail' => '\XeroAPI\XeroPHP\Models\Finance\ContactTotalDetail''total_other' => '\XeroAPI\XeroPHP\Models\Finance\ContactTotalOther''account_codes' => 'string[]'
    ];
    ...
    protected static $openAPIFormats = [
        'contact_id' => 'uuid''name' => null'total' => 'double''total_detail' => null'total_other' => null'account_codes' => null
    ];
    ...
    protected static $attributeMap = [
        'contact_id' => 'contactId''name' => 'name''total' => 'total''total_detail' => 'totalDetail''total_other' => 'totalOther''account_codes' => 'accountCodes'
    ];
    ...
    protected static $setters = [
        'contact_id' => 'setContactId''name' => 'setName''total' => 'setTotal''total_detail' => 'setTotalDetail''total_other' => 'setTotalOther''account_codes' => 'setAccountCodes'
    ];
    ...
    protected static $getters = [
        'contact_id' => 'getContactId''name' => 'getName''total' => 'getTotal''total_detail' => 'getTotalDetail''total_other' => 'getTotalOther''account_codes' => 'getAccountCodes'
    ];

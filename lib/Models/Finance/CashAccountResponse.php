...
class CashAccountResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'unreconciled_amount_pos' => 'double''unreconciled_amount_neg' => 'double''starting_balance' => 'double''account_balance' => 'double''balance_currency' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        'unreconciled_amount_pos' => 'double''unreconciled_amount_neg' => 'double''starting_balance' => 'double''account_balance' => 'double''balance_currency' => null
    ];
    ...
    protected static $attributeMap = [
        'unreconciled_amount_pos' => 'unreconciledAmountPos''unreconciled_amount_neg' => 'unreconciledAmountNeg''starting_balance' => 'startingBalance''account_balance' => 'accountBalance''balance_currency' => 'balanceCurrency'
    ];
    ...
    protected static $setters = [
        'unreconciled_amount_pos' => 'setUnreconciledAmountPos''unreconciled_amount_neg' => 'setUnreconciledAmountNeg''starting_balance' => 'setStartingBalance''account_balance' => 'setAccountBalance''balance_currency' => 'setBalanceCurrency'
    ];
    ...
    protected static $getters = [
        'unreconciled_amount_pos' => 'getUnreconciledAmountPos''unreconciled_amount_neg' => 'getUnreconciledAmountNeg''starting_balance' => 'getStartingBalance''account_balance' => 'getAccountBalance''balance_currency' => 'getBalanceCurrency'
    ];

...
class DataSourceResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'direct_bank_feed' => 'double''indirect_bank_feed' => 'double''file_upload' => 'double''manual' => 'double''direct_bank_feed_pos' => 'double''indirect_bank_feed_pos' => 'double''file_upload_pos' => 'double''manual_pos' => 'double''direct_bank_feed_neg' => 'double''indirect_bank_feed_neg' => 'double''file_upload_neg' => 'double''manual_neg' => 'double''other_pos' => 'double''other_neg' => 'double''other' => 'double'
    ];
    ...
    protected static $attributeMap = [
        'direct_bank_feed' => 'directBankFeed''indirect_bank_feed' => 'indirectBankFeed''file_upload' => 'fileUpload''manual' => 'manual''direct_bank_feed_pos' => 'directBankFeedPos''indirect_bank_feed_pos' => 'indirectBankFeedPos''file_upload_pos' => 'fileUploadPos''manual_pos' => 'manualPos''direct_bank_feed_neg' => 'directBankFeedNeg''indirect_bank_feed_neg' => 'indirectBankFeedNeg''file_upload_neg' => 'fileUploadNeg''manual_neg' => 'manualNeg''other_pos' => 'otherPos''other_neg' => 'otherNeg''other' => 'other'
    ];
    ...
    protected static $setters = [
        'direct_bank_feed' => 'setDirectBankFeed''indirect_bank_feed' => 'setIndirectBankFeed''file_upload' => 'setFileUpload''manual' => 'setManual''direct_bank_feed_pos' => 'setDirectBankFeedPos''indirect_bank_feed_pos' => 'setIndirectBankFeedPos''file_upload_pos' => 'setFileUploadPos''manual_pos' => 'setManualPos''direct_bank_feed_neg' => 'setDirectBankFeedNeg''indirect_bank_feed_neg' => 'setIndirectBankFeedNeg''file_upload_neg' => 'setFileUploadNeg''manual_neg' => 'setManualNeg''other_pos' => 'setOtherPos''other_neg' => 'setOtherNeg''other' => 'setOther'
    ];
    ...
    protected static $getters = [
        'direct_bank_feed' => 'getDirectBankFeed''indirect_bank_feed' => 'getIndirectBankFeed''file_upload' => 'getFileUpload''manual' => 'getManual''direct_bank_feed_pos' => 'getDirectBankFeedPos''indirect_bank_feed_pos' => 'getIndirectBankFeedPos''file_upload_pos' => 'getFileUploadPos''manual_pos' => 'getManualPos''direct_bank_feed_neg' => 'getDirectBankFeedNeg''indirect_bank_feed_neg' => 'getIndirectBankFeedNeg''file_upload_neg' => 'getFileUploadNeg''manual_neg' => 'getManualNeg''other_pos' => 'getOtherPos''other_neg' => 'getOtherNeg''other' => 'getOther'
    ];

...
class StatementLineResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'statement_line_id' => 'string''posted_date' => '\DateTime''reference' => 'string''notes' => 'string''cheque_no' => 'string''amount' => 'double''transaction_date' => '\DateTime''type' => 'string''is_reconciled' => 'bool''is_duplicate' => 'bool''is_deleted' => 'bool''payments' => '\XeroAPI\XeroPHP\Models\Finance\PaymentResponse[]''bank_transactions' => '\XeroAPI\XeroPHP\Models\Finance\BankTransactionResponse[]'
    ];
    ...
    protected static $openAPIFormats = [
        'statement_line_id' => 'uuid''posted_date' => 'date''reference' => null'notes' => null'cheque_no' => null'amount' => 'double''transaction_date' => 'date''type' => null'is_reconciled' => null'is_duplicate' => null'is_deleted' => null'payments' => null'bank_transactions' => null
    ];
    ...
    protected static $attributeMap = [
        'statement_line_id' => 'statementLineId''posted_date' => 'postedDate''reference' => 'reference''notes' => 'notes''cheque_no' => 'chequeNo''amount' => 'amount''transaction_date' => 'transactionDate''type' => 'type''is_reconciled' => 'isReconciled''is_duplicate' => 'isDuplicate''is_deleted' => 'isDeleted''payments' => 'payments''bank_transactions' => 'bankTransactions'
    ];
    ...
    protected static $setters = [
        'statement_line_id' => 'setStatementLineId''posted_date' => 'setPostedDate''reference' => 'setReference''notes' => 'setNotes''cheque_no' => 'setChequeNo''amount' => 'setAmount''transaction_date' => 'setTransactionDate''type' => 'setType''is_reconciled' => 'setIsReconciled''is_duplicate' => 'setIsDuplicate''is_deleted' => 'setIsDeleted''payments' => 'setPayments''bank_transactions' => 'setBankTransactions'
    ];
    ...
    protected static $getters = [
        'statement_line_id' => 'getStatementLineId''posted_date' => 'getPostedDate''reference' => 'getReference''notes' => 'getNotes''cheque_no' => 'getChequeNo''amount' => 'getAmount''transaction_date' => 'getTransactionDate''type' => 'getType''is_reconciled' => 'getIsReconciled''is_duplicate' => 'getIsDuplicate''is_deleted' => 'getIsDeleted''payments' => 'getPayments''bank_transactions' => 'getBankTransactions'
    ];

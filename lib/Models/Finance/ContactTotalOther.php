...
class ContactTotalOther implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'total_outstanding_aged' => 'double''total_voided' => 'double''total_credited' => 'double''transaction_count' => 'int'
    ];
    ...
    protected static $openAPIFormats = [
        'total_outstanding_aged' => 'double''total_voided' => 'double''total_credited' => 'double''transaction_count' => 'int32'
    ];
    ...
    protected static $attributeMap = [
        'total_outstanding_aged' => 'totalOutstandingAged''total_voided' => 'totalVoided''total_credited' => 'totalCredited''transaction_count' => 'transactionCount'
    ];
    ...
    protected static $setters = [
        'total_outstanding_aged' => 'setTotalOutstandingAged''total_voided' => 'setTotalVoided''total_credited' => 'setTotalCredited''transaction_count' => 'setTransactionCount'
    ];
    ...
    protected static $getters = [
        'total_outstanding_aged' => 'getTotalOutstandingAged''total_voided' => 'getTotalVoided''total_credited' => 'getTotalCredited''transaction_count' => 'getTransactionCount'
    ];

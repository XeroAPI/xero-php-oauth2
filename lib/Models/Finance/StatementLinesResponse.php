...
class StatementLinesResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'unreconciled_amount_pos' => 'double''unreconciled_amount_neg' => 'double''unreconciled_lines' => 'int''avg_days_unreconciled_pos' => 'double''avg_days_unreconciled_neg' => 'double''earliest_unreconciled_transaction' => '\DateTime''latest_unreconciled_transaction' => '\DateTime''deleted_amount' => 'double''total_amount' => 'double''data_source' => '\XeroAPI\XeroPHP\Models\Finance\DataSourceResponse''earliest_reconciled_transaction' => '\DateTime''latest_reconciled_transaction' => '\DateTime''reconciled_amount_pos' => 'double''reconciled_amount_neg' => 'double''reconciled_lines' => 'int''total_amount_pos' => 'double''total_amount_neg' => 'double'
    ];
    ...
    protected static $openAPIFormats = [
        'unreconciled_amount_pos' => 'double''unreconciled_amount_neg' => 'double''unreconciled_lines' => 'int32''avg_days_unreconciled_pos' => 'double''avg_days_unreconciled_neg' => 'double''earliest_unreconciled_transaction' => 'date''latest_unreconciled_transaction' => 'date''deleted_amount' => 'double''total_amount' => 'double''data_source' => null'earliest_reconciled_transaction' => 'date''latest_reconciled_transaction' => 'date''reconciled_amount_pos' => 'double''reconciled_amount_neg' => 'double''reconciled_lines' => 'int32''total_amount_pos' => 'double''total_amount_neg' => 'double'
    ];
    ...
    protected static $setters = [
        'unreconciled_amount_pos' => 'setUnreconciledAmountPos''unreconciled_amount_neg' => 'setUnreconciledAmountNeg''unreconciled_lines' => 'setUnreconciledLines''avg_days_unreconciled_pos' => 'setAvgDaysUnreconciledPos''avg_days_unreconciled_neg' => 'setAvgDaysUnreconciledNeg''earliest_unreconciled_transaction' => 'setEarliestUnreconciledTransaction''latest_unreconciled_transaction' => 'setLatestUnreconciledTransaction''deleted_amount' => 'setDeletedAmount''total_amount' => 'setTotalAmount''data_source' => 'setDataSource''earliest_reconciled_transaction' => 'setEarliestReconciledTransaction''latest_reconciled_transaction' => 'setLatestReconciledTransaction''reconciled_amount_pos' => 'setReconciledAmountPos''reconciled_amount_neg' => 'setReconciledAmountNeg''reconciled_lines' => 'setReconciledLines''total_amount_pos' => 'setTotalAmountPos''total_amount_neg' => 'setTotalAmountNeg'
    ];
    ...
    protected static $getters = [
        'unreconciled_amount_pos' => 'getUnreconciledAmountPos''unreconciled_amount_neg' => 'getUnreconciledAmountNeg''unreconciled_lines' => 'getUnreconciledLines''avg_days_unreconciled_pos' => 'getAvgDaysUnreconciledPos''avg_days_unreconciled_neg' => 'getAvgDaysUnreconciledNeg''earliest_unreconciled_transaction' => 'getEarliestUnreconciledTransaction''latest_unreconciled_transaction' => 'getLatestUnreconciledTransaction''deleted_amount' => 'getDeletedAmount''total_amount' => 'getTotalAmount''data_source' => 'getDataSource''earliest_reconciled_transaction' => 'getEarliestReconciledTransaction''latest_reconciled_transaction' => 'getLatestReconciledTransaction''reconciled_amount_pos' => 'getReconciledAmountPos''reconciled_amount_neg' => 'getReconciledAmountNeg''reconciled_lines' => 'getReconciledLines''total_amount_pos' => 'getTotalAmountPos''total_amount_neg' => 'getTotalAmountNeg'
    ];

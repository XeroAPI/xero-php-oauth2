...
class Address implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'address_line1' => 'string''address_line2' => 'string''city' => 'string''post_code' => 'string''country_name' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        'address_line1' => null'address_line2' => null'city' => null'post_code' => null'country_name' => null
    ];
    ...
    protected static $attributeMap = [
        'address_line1' => 'addressLine1''address_line2' => 'addressLine2''city' => 'city''post_code' => 'postCode''country_name' => 'countryName'
    ];
    ...
    protected static $setters = [
        'address_line1' => 'setAddressLine1''address_line2' => 'setAddressLine2''city' => 'setCity''post_code' => 'setPostCode''country_name' => 'setCountryName'
    ];
    ...
    protected static $getters = [
        'address_line1' => 'getAddressLine1''address_line2' => 'getAddressLine2''city' => 'getCity''post_code' => 'getPostCode''country_name' => 'getCountryName'
    ];

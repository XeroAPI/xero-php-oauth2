...
class StatutoryDeduction implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'id' => 'string''name' => 'string''statutory_deduction_category' => '\XeroAPI\XeroPHP\Models\PayrollUk\StatutoryDeductionCategory''liability_account_id' => 'string''current_record' => 'bool'
    ];

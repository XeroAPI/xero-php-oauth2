...
class EmployeeStatutorySickLeave implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'statutory_leave_id' => 'string''employee_id' => 'string''leave_type_id' => 'string''start_date' => '\DateTime''end_date' => '\DateTime''type' => 'string''status' => 'string''work_pattern' => 'string[]''is_pregnancy_related' => 'bool''sufficient_notice' => 'bool''is_entitled' => 'bool''entitlement_weeks_requested' => 'double''entitlement_weeks_qualified' => 'double''entitlement_weeks_remaining' => 'double''overlaps_with_other_leave' => 'bool''entitlement_failure_reasons' => 'string[]'
    ];
    ...
    protected static $openAPIFormats = [
        'statutory_leave_id' => 'uuid''employee_id' => 'uuid''leave_type_id' => 'uuid''start_date' => 'date''end_date' => 'date''type' => null'status' => null'work_pattern' => null'is_pregnancy_related' => null'sufficient_notice' => null'is_entitled' => null'entitlement_weeks_requested' => 'double''entitlement_weeks_qualified' => 'double''entitlement_weeks_remaining' => 'double''overlaps_with_other_leave' => null'entitlement_failure_reasons' => null
    ];
    ...
    protected static $setters = [
        'statutory_leave_id' => 'setStatutoryLeaveId''employee_id' => 'setEmployeeId''leave_type_id' => 'setLeaveTypeId''start_date' => 'setStartDate''end_date' => 'setEndDate''type' => 'setType''status' => 'setStatus''work_pattern' => 'setWorkPattern''is_pregnancy_related' => 'setIsPregnancyRelated''sufficient_notice' => 'setSufficientNotice''is_entitled' => 'setIsEntitled''entitlement_weeks_requested' => 'setEntitlementWeeksRequested''entitlement_weeks_qualified' => 'setEntitlementWeeksQualified''entitlement_weeks_remaining' => 'setEntitlementWeeksRemaining''overlaps_with_other_leave' => 'setOverlapsWithOtherLeave''entitlement_failure_reasons' => 'setEntitlementFailureReasons'
    ];
    ...
    protected static $getters = [
        'statutory_leave_id' => 'getStatutoryLeaveId''employee_id' => 'getEmployeeId''leave_type_id' => 'getLeaveTypeId''start_date' => 'getStartDate''end_date' => 'getEndDate''type' => 'getType''status' => 'getStatus''work_pattern' => 'getWorkPattern''is_pregnancy_related' => 'getIsPregnancyRelated''sufficient_notice' => 'getSufficientNotice''is_entitled' => 'getIsEntitled''entitlement_weeks_requested' => 'getEntitlementWeeksRequested''entitlement_weeks_qualified' => 'getEntitlementWeeksQualified''entitlement_weeks_remaining' => 'getEntitlementWeeksRemaining''overlaps_with_other_leave' => 'getOverlapsWithOtherLeave''entitlement_failure_reasons' => 'getEntitlementFailureReasons'
    ];

...
class Benefit implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['standard_amount'] === null) {
            $invalidProperties[] = "'standard_amount' can't be null";
        }
     ...
     *
     * @param double $standard_amount Standard amount of the employer pension
     *
     * @return $this
     */

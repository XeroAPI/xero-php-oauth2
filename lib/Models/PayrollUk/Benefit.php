...
class Benefit implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'id' => 'string''name' => 'string''category' => 'string''liability_account_id' => 'string''expense_account_id' => 'string''standard_amount' => 'double''percentage' => 'double''calculation_type' => 'string''current_record' => 'bool''subject_to_nic' => 'bool''subject_to_pension' => 'bool''subject_to_tax' => 'bool''is_calculating_on_qualifying_earnings' => 'bool''show_balance_to_employee' => 'bool'
    ];
    ...
    protected static $attributeMap = [
        'id' => 'id''name' => 'name''category' => 'category''liability_account_id' => 'liabilityAccountId''expense_account_id' => 'expenseAccountId''standard_amount' => 'standardAmount''percentage' => 'percentage''calculation_type' => 'calculationType''current_record' => 'currentRecord''subject_to_nic' => 'subjectToNIC''subject_to_pension' => 'subjectToPension''subject_to_tax' => 'subjectToTax''is_calculating_on_qualifying_earnings' => 'isCalculatingOnQualifyingEarnings''show_balance_to_employee' => 'showBalanceToEmployee'
    ];
    ...
    protected static $setters = [
        'id' => 'setId''name' => 'setName''category' => 'setCategory''liability_account_id' => 'setLiabilityAccountId''expense_account_id' => 'setExpenseAccountId''standard_amount' => 'setStandardAmount''percentage' => 'setPercentage''calculation_type' => 'setCalculationType''current_record' => 'setCurrentRecord''subject_to_nic' => 'setSubjectToNic''subject_to_pension' => 'setSubjectToPension''subject_to_tax' => 'setSubjectToTax''is_calculating_on_qualifying_earnings' => 'setIsCalculatingOnQualifyingEarnings''show_balance_to_employee' => 'setShowBalanceToEmployee'
    ];
    ...
    protected static $getters = [
        'id' => 'getId''name' => 'getName''category' => 'getCategory''liability_account_id' => 'getLiabilityAccountId''expense_account_id' => 'getExpenseAccountId''standard_amount' => 'getStandardAmount''percentage' => 'getPercentage''calculation_type' => 'getCalculationType''current_record' => 'getCurrentRecord''subject_to_nic' => 'getSubjectToNic''subject_to_pension' => 'getSubjectToPension''subject_to_tax' => 'getSubjectToTax''is_calculating_on_qualifying_earnings' => 'getIsCalculatingOnQualifyingEarnings''show_balance_to_employee' => 'getShowBalanceToEmployee'
    ];

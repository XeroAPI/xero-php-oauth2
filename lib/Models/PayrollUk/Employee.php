...
class Employee implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'employee_id' => 'string''title' => 'string''first_name' => 'string''last_name' => 'string''date_of_birth' => '\DateTime''address' => '\XeroAPI\XeroPHP\Models\PayrollUk\Address''email' => 'string''gender' => 'string''phone_number' => 'string''start_date' => '\DateTime''end_date' => '\DateTime''payroll_calendar_id' => 'string''updated_date_utc' => '\DateTime''created_date_utc' => '\DateTime''national_insurance_number' => 'string''is_off_payroll_worker' => 'bool'
    ];
    ...
    protected static $openAPIFormats = [
        'employee_id' => 'uuid''title' => null'first_name' => null'last_name' => null'date_of_birth' => 'date''address' => null'email' => null'gender' => null'phone_number' => null'start_date' => 'date''end_date' => 'date''payroll_calendar_id' => 'uuid''updated_date_utc' => 'date-time''created_date_utc' => 'date-time''national_insurance_number' => null'is_off_payroll_worker' => null
    ];
    ...
    protected static $attributeMap = [
        'employee_id' => 'employeeID''title' => 'title''first_name' => 'firstName''last_name' => 'lastName''date_of_birth' => 'dateOfBirth''address' => 'address''email' => 'email''gender' => 'gender''phone_number' => 'phoneNumber''start_date' => 'startDate''end_date' => 'endDate''payroll_calendar_id' => 'payrollCalendarID''updated_date_utc' => 'updatedDateUTC''created_date_utc' => 'createdDateUTC''national_insurance_number' => 'nationalInsuranceNumber''is_off_payroll_worker' => 'isOffPayrollWorker'
    ];
    ...
    protected static $setters = [
        'employee_id' => 'setEmployeeId''title' => 'setTitle''first_name' => 'setFirstName''last_name' => 'setLastName''date_of_birth' => 'setDateOfBirth''address' => 'setAddress''email' => 'setEmail''gender' => 'setGender''phone_number' => 'setPhoneNumber''start_date' => 'setStartDate''end_date' => 'setEndDate''payroll_calendar_id' => 'setPayrollCalendarId''updated_date_utc' => 'setUpdatedDateUtc''created_date_utc' => 'setCreatedDateUtc''national_insurance_number' => 'setNationalInsuranceNumber''is_off_payroll_worker' => 'setIsOffPayrollWorker'
    ];
    ...
    protected static $getters = [
        'employee_id' => 'getEmployeeId''title' => 'getTitle''first_name' => 'getFirstName''last_name' => 'getLastName''date_of_birth' => 'getDateOfBirth''address' => 'getAddress''email' => 'getEmail''gender' => 'getGender''phone_number' => 'getPhoneNumber''start_date' => 'getStartDate''end_date' => 'getEndDate''payroll_calendar_id' => 'getPayrollCalendarId''updated_date_utc' => 'getUpdatedDateUtc''created_date_utc' => 'getCreatedDateUtc''national_insurance_number' => 'getNationalInsuranceNumber''is_off_payroll_worker' => 'getIsOffPayrollWorker'
    ];

...
class SalaryAndWage implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'salary_and_wages_id' => 'string''earnings_rate_id' => 'string''number_of_units_per_week' => 'double''rate_per_unit' => 'double''number_of_units_per_day' => 'double''effective_from' => '\DateTime''annual_salary' => 'double''status' => 'string''payment_type' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        'salary_and_wages_id' => 'uuid''earnings_rate_id' => 'uuid''number_of_units_per_week' => 'double''rate_per_unit' => 'double''number_of_units_per_day' => 'double''effective_from' => 'date''annual_salary' => 'double''status' => null'payment_type' => null
    ];
    ...
    protected static $attributeMap = [
        'salary_and_wages_id' => 'salaryAndWagesID''earnings_rate_id' => 'earningsRateID''number_of_units_per_week' => 'numberOfUnitsPerWeek''rate_per_unit' => 'ratePerUnit''number_of_units_per_day' => 'numberOfUnitsPerDay''effective_from' => 'effectiveFrom''annual_salary' => 'annualSalary''status' => 'status''payment_type' => 'paymentType'
    ];

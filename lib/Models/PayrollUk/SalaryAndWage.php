...
class SalaryAndWage implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['rate_per_unit'] === null) {
            $invalidProperties[] = "'rate_per_unit' can't be null";
        }
     ...
     * Sets rate_per_unit
     *
     * @param double $rate_per_unit The rate of each unit for the corresponding salary and wages
     *
     * @return $this
     */

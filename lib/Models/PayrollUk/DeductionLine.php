...
class DeductionLine implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'deduction_type_id' => 'string''amount' => 'double''subject_to_tax' => 'bool''percentage' => 'double'
    ];
    ...
    protected static $openAPIFormats = [
        'deduction_type_id' => 'uuid''amount' => 'double''subject_to_tax' => null'percentage' => 'double'
    ];
    ...
    protected static $attributeMap = [
        'deduction_type_id' => 'deductionTypeID''amount' => 'amount''subject_to_tax' => 'subjectToTax''percentage' => 'percentage'
    ];
    ...
    protected static $setters = [
        'deduction_type_id' => 'setDeductionTypeId''amount' => 'setAmount''subject_to_tax' => 'setSubjectToTax''percentage' => 'setPercentage'
    ];
    ...
    protected static $getters = [
        'deduction_type_id' => 'getDeductionTypeId''amount' => 'getAmount''subject_to_tax' => 'getSubjectToTax''percentage' => 'getPercentage'
    ];

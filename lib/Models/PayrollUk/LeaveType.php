...
class LeaveType implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'leave_id' => 'string''leave_type_id' => 'string''name' => 'string''is_paid_leave' => 'bool''show_on_payslip' => 'bool''updated_date_utc' => '\DateTime''is_active' => 'bool''is_statutory_leave' => 'bool'
    ];
    ...
    protected static $openAPIFormats = [
        'leave_id' => 'uuid''leave_type_id' => 'uuid''name' => null'is_paid_leave' => null'show_on_payslip' => null'updated_date_utc' => 'date-time''is_active' => null'is_statutory_leave' => null
    ];
    ...
    protected static $attributeMap = [
        'leave_id' => 'leaveID''leave_type_id' => 'leaveTypeID''name' => 'name''is_paid_leave' => 'isPaidLeave''show_on_payslip' => 'showOnPayslip''updated_date_utc' => 'updatedDateUTC''is_active' => 'isActive''is_statutory_leave' => 'isStatutoryLeave'
    ];
    ...
    protected static $setters = [
        'leave_id' => 'setLeaveId''leave_type_id' => 'setLeaveTypeId''name' => 'setName''is_paid_leave' => 'setIsPaidLeave''show_on_payslip' => 'setShowOnPayslip''updated_date_utc' => 'setUpdatedDateUtc''is_active' => 'setIsActive''is_statutory_leave' => 'setIsStatutoryLeave'
    ];
    ...
    protected static $getters = [
        'leave_id' => 'getLeaveId''leave_type_id' => 'getLeaveTypeId''name' => 'getName''is_paid_leave' => 'getIsPaidLeave''show_on_payslip' => 'getShowOnPayslip''updated_date_utc' => 'getUpdatedDateUtc''is_active' => 'getIsActive''is_statutory_leave' => 'getIsStatutoryLeave'
    ];

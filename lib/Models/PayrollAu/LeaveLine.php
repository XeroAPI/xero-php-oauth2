...
class LeaveLine implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param bool $is_qualifying_earnings Boolean to determine if the leave line is considered as qualifying earnings for superannuation guarantee calculations
     *
     * @return $this
     */

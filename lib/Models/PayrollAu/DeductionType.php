...
class DeductionType implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'name' => 'string''account_code' => 'string''reduces_tax' => 'bool''reduces_super' => 'bool''is_exempt_from_w1' => 'bool''deduction_type_id' => 'string''updated_date_utc' => 'string''deduction_category' => 'string''current_record' => 'bool'
    ];
    ...
    protected static $openAPIFormats = [
        'name' => null'account_code' => null'reduces_tax' => null'reduces_super' => null'is_exempt_from_w1' => null'deduction_type_id' => 'uuid''updated_date_utc' => null'deduction_category' => null'current_record' => null
    ];
    ...
    protected static $attributeMap = [
        'name' => 'Name''account_code' => 'AccountCode''reduces_tax' => 'ReducesTax''reduces_super' => 'ReducesSuper''is_exempt_from_w1' => 'IsExemptFromW1''deduction_type_id' => 'DeductionTypeID''updated_date_utc' => 'UpdatedDateUTC''deduction_category' => 'DeductionCategory''current_record' => 'CurrentRecord'
    ];
    ...
    protected static $setters = [
        'name' => 'setName''account_code' => 'setAccountCode''reduces_tax' => 'setReducesTax''reduces_super' => 'setReducesSuper''is_exempt_from_w1' => 'setIsExemptFromW1''deduction_type_id' => 'setDeductionTypeId''updated_date_utc' => 'setUpdatedDateUtc''deduction_category' => 'setDeductionCategory''current_record' => 'setCurrentRecord'
    ];
    ...
    protected static $getters = [
        'name' => 'getName''account_code' => 'getAccountCode''reduces_tax' => 'getReducesTax''reduces_super' => 'getReducesSuper''is_exempt_from_w1' => 'getIsExemptFromW1''deduction_type_id' => 'getDeductionTypeId''updated_date_utc' => 'getUpdatedDateUtc''deduction_category' => 'getDeductionCategory''current_record' => 'getCurrentRecord'
    ];

...
class LeaveType implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'name' => 'string''type_of_units' => 'string''leave_type_id' => 'string''normal_entitlement' => 'double''leave_loading_rate' => 'double''updated_date_utc' => 'string''is_paid_leave' => 'bool''show_on_payslip' => 'bool''current_record' => 'bool'
    ];
    ...
    protected static $openAPIFormats = [
        'name' => null'type_of_units' => null'leave_type_id' => 'uuid''normal_entitlement' => 'double''leave_loading_rate' => 'double''updated_date_utc' => null'is_paid_leave' => null'show_on_payslip' => null'current_record' => null
    ];
    ...
    protected static $attributeMap = [
        'name' => 'Name''type_of_units' => 'TypeOfUnits''leave_type_id' => 'LeaveTypeID''normal_entitlement' => 'NormalEntitlement''leave_loading_rate' => 'LeaveLoadingRate''updated_date_utc' => 'UpdatedDateUTC''is_paid_leave' => 'IsPaidLeave''show_on_payslip' => 'ShowOnPayslip''current_record' => 'CurrentRecord'
    ];
    ...
    protected static $setters = [
        'name' => 'setName''type_of_units' => 'setTypeOfUnits''leave_type_id' => 'setLeaveTypeId''normal_entitlement' => 'setNormalEntitlement''leave_loading_rate' => 'setLeaveLoadingRate''updated_date_utc' => 'setUpdatedDateUtc''is_paid_leave' => 'setIsPaidLeave''show_on_payslip' => 'setShowOnPayslip''current_record' => 'setCurrentRecord'
    ];
    ...
    protected static $getters = [
        'name' => 'getName''type_of_units' => 'getTypeOfUnits''leave_type_id' => 'getLeaveTypeId''normal_entitlement' => 'getNormalEntitlement''leave_loading_rate' => 'getLeaveLoadingRate''updated_date_utc' => 'getUpdatedDateUtc''is_paid_leave' => 'getIsPaidLeave''show_on_payslip' => 'getShowOnPayslip''current_record' => 'getCurrentRecord'
    ];

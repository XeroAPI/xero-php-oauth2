...
class EarningsLine implements ModelInterface, ArrayAccess
{
     ...
     * Sets annual_salary
     *
     * @param float|null $annual_salary Annual salary for earnings line
     *
     * @return $this
     */
     ...
     *
     * @param float|null $number_of_units_per_week number of units for earning line
     *
     * @return $this
     */
     ...
     * Sets rate_per_unit
     *
     * @param float|null $rate_per_unit Rate per unit of the EarningsLine.
     *
     * @return $this
     */
     ...
     *
     * @param float|null $normal_number_of_units Normal number of units for EarningsLine. Applicable when RateType is \"MULTIPLE\"
     *
     * @return $this
     */
     ...
     * Sets amount
     *
     * @param float|null $amount Earnings rate amount
     *
     * @return $this
     */
     ...
     *
     * @param float|null $number_of_units Earnings rate number of units.
     *
     * @return $this
     */
     ...
     * Sets fixed_amount
     *
     * @param float|null $fixed_amount Earnings rate amount. Only applicable if the EarningsRate RateType is Fixed
     *
     * @return $this
     */

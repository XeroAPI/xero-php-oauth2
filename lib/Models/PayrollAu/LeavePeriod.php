...
class LeavePeriod implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param float|null $number_of_units The Number of Units for the leave
     *
     * @return $this
     */
    ...
    public function setPayPeriodEndDateAsDate($pay_period_end_date)
    {
      ...
      {        
        $timeInMillis = strtotime($pay_period_end_date->format('Y-m-d')) * 1000;
    ...
    public function setPayPeriodStartDateAsDate($pay_period_start_date)
    {
      ...
      {        
        $timeInMillis = strtotime($pay_period_start_date->format('Y-m-d')) * 1000;

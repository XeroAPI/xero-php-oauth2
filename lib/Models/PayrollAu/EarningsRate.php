...
class EarningsRate implements ModelInterface, ArrayAccess
{
     ...
     * Sets accrue_leave
     *
     * @param float|null $accrue_leave Indicates that this earnings rate should accrue leave. Only applicable if RateType is MULTIPLE
     *
     * @return $this
     */
     ...
     * Sets amount
     *
     * @param float|null $amount Optional Amount for FIXEDAMOUNT RateType EarningsRate
     *
     * @return $this
     */

...
class SuperannuationLine implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param float|null $minimum_monthly_earnings Superannuation minimum monthly earnings.
     *
     * @return $this
     */
    ...
    public function setPaymentDateForThisPeriodAsDate($payment_date_for_this_period)
    {
      ...
      {        
        $timeInMillis = strtotime($payment_date_for_this_period->format('Y-m-d')) * 1000;
     ...
     * Sets percentage
     *
     * @param float|null $percentage Superannuation percentage
     *
     * @return $this
     */

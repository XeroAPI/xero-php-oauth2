...
class SuperannuationLine implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'super_membership_id' => 'string''contribution_type' => '\XeroAPI\XeroPHP\Models\PayrollAu\SuperannuationContributionType''calculation_type' => '\XeroAPI\XeroPHP\Models\PayrollAu\SuperannuationCalculationType''minimum_monthly_earnings' => 'double''expense_account_code' => 'string''liability_account_code' => 'string''payment_date_for_this_period' => 'string''percentage' => 'double''amount' => 'double'
    ];
    ...
    protected static $openAPIFormats = [
        'super_membership_id' => 'uuid''contribution_type' => null'calculation_type' => null'minimum_monthly_earnings' => 'double''expense_account_code' => null'liability_account_code' => null'payment_date_for_this_period' => null'percentage' => 'double''amount' => 'double'
    ];
    ...
    protected static $attributeMap = [
        'super_membership_id' => 'SuperMembershipID''contribution_type' => 'ContributionType''calculation_type' => 'CalculationType''minimum_monthly_earnings' => 'MinimumMonthlyEarnings''expense_account_code' => 'ExpenseAccountCode''liability_account_code' => 'LiabilityAccountCode''payment_date_for_this_period' => 'PaymentDateForThisPeriod''percentage' => 'Percentage''amount' => 'Amount'
    ];
    ...
    protected static $setters = [
        'super_membership_id' => 'setSuperMembershipId''contribution_type' => 'setContributionType''calculation_type' => 'setCalculationType''minimum_monthly_earnings' => 'setMinimumMonthlyEarnings''expense_account_code' => 'setExpenseAccountCode''liability_account_code' => 'setLiabilityAccountCode''payment_date_for_this_period' => 'setPaymentDateForThisPeriod''percentage' => 'setPercentage''amount' => 'setAmount'
    ];
    ...
    protected static $getters = [
        'super_membership_id' => 'getSuperMembershipId''contribution_type' => 'getContributionType''calculation_type' => 'getCalculationType''minimum_monthly_earnings' => 'getMinimumMonthlyEarnings''expense_account_code' => 'getExpenseAccountCode''liability_account_code' => 'getLiabilityAccountCode''payment_date_for_this_period' => 'getPaymentDateForThisPeriod''percentage' => 'getPercentage''amount' => 'getAmount'
    ];

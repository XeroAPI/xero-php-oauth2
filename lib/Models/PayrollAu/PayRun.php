...
class PayRun implements ModelInterface, ArrayAccess
{
    ...
    public function setPayRunPeriodStartDateAsDate($pay_run_period_start_date)
    {
      ...
      {        
        $timeInMillis = strtotime($pay_run_period_start_date->format('Y-m-d')) * 1000;
    ...
    public function setPayRunPeriodEndDateAsDate($pay_run_period_end_date)
    {
      ...
      {        
        $timeInMillis = strtotime($pay_run_period_end_date->format('Y-m-d')) * 1000;
    ...
    public function setPaymentDateAsDate($payment_date)
    {
      ...
      {        
        $timeInMillis = strtotime($payment_date->format('Y-m-d')) * 1000;
     ...
     * Sets reimbursement
     *
     * @param float|null $reimbursement The total Reimbursements for the Payrun
     *
     * @return $this
     */
     ...
     * Sets net_pay
     *
     * @param float|null $net_pay The total NetPay for the Payrun
     *
     * @return $this
     */

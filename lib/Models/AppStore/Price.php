...
class Price implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'amount' => 'double''currency' => 'string''id' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        'amount' => 'double''currency' => null'id' => 'uuid'
    ];
    ...
    protected static $setters = [
        'amount' => 'setAmount''currency' => 'setCurrency''id' => 'setId'
    ];
    ...
    protected static $getters = [
        'amount' => 'getAmount''currency' => 'getCurrency''id' => 'getId'
    ];

...
class Asset implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['asset_status']) && !in_array($this->container['asset_status'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'asset_status', must be one of '%s'",
     ...
     * Sets asset_id
     *
     * @param string $asset_id The Xero-generated Id for the asset
     *
     * @return $this
     */
     ...
     * Sets purchase_price
     *
     * @param float|null $purchase_price The purchase price of the asset
     *
     * @return $this
     */
     ...
     * Sets disposal_price
     *
     * @param float|null $disposal_price The price the asset was disposed at
     *
     * @return $this
     */
     ...
     * Sets asset_status
     *
     * @param string|null $asset_status See Asset Status Codes.
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getAssetStatusAllowableValues();
        if (!is_null($asset_status) && !in_array($asset_status, $allowedValues, true)) {
     ...
     *
     * @param float|null $accounting_book_value The accounting value of the asset
     *
     * @return $this
     */

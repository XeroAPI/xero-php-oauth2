...
/**
 * TrackingReference Class Doc Comment
 *
 * @category Class
 * @package  XeroAPI\XeroPHP
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class TrackingReference implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TrackingReference';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['tracking_category_id'] === null) {
            $invalidProperties[] = "'tracking_category_id' can't be null";
        }
        if ($this->container['tracking_option_id'] === null) {
            $invalidProperties[] = "'tracking_option_id' can't be null";
        }
     ...
     *
     * @param string $tracking_category_id The Xero identifier for a tracking category
     *
     * @return $this
     */
     ...
     *
     * @param string $tracking_option_id The Xero identifier for a tracking category option
     *
     * @return $this
     */
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling TrackingReference., must be smaller than or equal to 100.');
        }

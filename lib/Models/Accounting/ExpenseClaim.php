...
class ExpenseClaim implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'expense_claim_id' => 'string''status' => 'string''payments' => '\XeroAPI\XeroPHP\Models\Accounting\Payment[]''user' => '\XeroAPI\XeroPHP\Models\Accounting\User''receipts' => '\XeroAPI\XeroPHP\Models\Accounting\Receipt[]''updated_date_utc' => 'string''total' => 'double''amount_due' => 'double''amount_paid' => 'double''payment_due_date' => 'string''reporting_date' => 'string''receipt_id' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        'expense_claim_id' => 'uuid''status' => null'payments' => null'user' => null'receipts' => null'updated_date_utc' => null'total' => 'double''amount_due' => 'double''amount_paid' => 'double''payment_due_date' => null'reporting_date' => null'receipt_id' => 'uuid'
    ];
    ...
    protected static $attributeMap = [
        'expense_claim_id' => 'ExpenseClaimID''status' => 'Status''payments' => 'Payments''user' => 'User''receipts' => 'Receipts''updated_date_utc' => 'UpdatedDateUTC''total' => 'Total''amount_due' => 'AmountDue''amount_paid' => 'AmountPaid''payment_due_date' => 'PaymentDueDate''reporting_date' => 'ReportingDate''receipt_id' => 'ReceiptID'
    ];
    ...
    protected static $setters = [
        'expense_claim_id' => 'setExpenseClaimId''status' => 'setStatus''payments' => 'setPayments''user' => 'setUser''receipts' => 'setReceipts''updated_date_utc' => 'setUpdatedDateUtc''total' => 'setTotal''amount_due' => 'setAmountDue''amount_paid' => 'setAmountPaid''payment_due_date' => 'setPaymentDueDate''reporting_date' => 'setReportingDate''receipt_id' => 'setReceiptId'
    ];
    ...
    protected static $getters = [
        'expense_claim_id' => 'getExpenseClaimId''status' => 'getStatus''payments' => 'getPayments''user' => 'getUser''receipts' => 'getReceipts''updated_date_utc' => 'getUpdatedDateUtc''total' => 'getTotal''amount_due' => 'getAmountDue''amount_paid' => 'getAmountPaid''payment_due_date' => 'getPaymentDueDate''reporting_date' => 'getReportingDate''receipt_id' => 'getReceiptId'
    ];

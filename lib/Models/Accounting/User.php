...
class User implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'user_id' => 'string''email_address' => 'string''first_name' => 'string''last_name' => 'string''updated_date_utc' => 'string''is_subscriber' => 'bool''organisation_role' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        'user_id' => 'uuid''email_address' => null'first_name' => null'last_name' => null'updated_date_utc' => null'is_subscriber' => null'organisation_role' => null
    ];
    ...
    protected static $attributeMap = [
        'user_id' => 'UserID''email_address' => 'EmailAddress''first_name' => 'FirstName''last_name' => 'LastName''updated_date_utc' => 'UpdatedDateUTC''is_subscriber' => 'IsSubscriber''organisation_role' => 'OrganisationRole'
    ];
    ...
    protected static $setters = [
        'user_id' => 'setUserId''email_address' => 'setEmailAddress''first_name' => 'setFirstName''last_name' => 'setLastName''updated_date_utc' => 'setUpdatedDateUtc''is_subscriber' => 'setIsSubscriber''organisation_role' => 'setOrganisationRole'
    ];
    ...
    protected static $getters = [
        'user_id' => 'getUserId''email_address' => 'getEmailAddress''first_name' => 'getFirstName''last_name' => 'getLastName''updated_date_utc' => 'getUpdatedDateUtc''is_subscriber' => 'getIsSubscriber''organisation_role' => 'getOrganisationRole'
    ];

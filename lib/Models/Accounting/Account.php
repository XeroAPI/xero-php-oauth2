...
class Account implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'code' => 'string''name' => 'string''account_id' => 'string''type' => '\XeroAPI\XeroPHP\Models\Accounting\AccountType''bank_account_number' => 'string''status' => 'string''description' => 'string''bank_account_type' => 'string''currency_code' => '\XeroAPI\XeroPHP\Models\Accounting\CurrencyCode''tax_type' => 'string''enable_payments_to_account' => 'bool''show_in_expense_claims' => 'bool''class' => 'string''system_account' => 'string''reporting_code' => 'string''reporting_code_name' => 'string''has_attachments' => 'bool''updated_date_utc' => 'string''add_to_watchlist' => 'bool''validation_errors' => '\XeroAPI\XeroPHP\Models\Accounting\ValidationError[]'
    ];
    ...
    protected static $openAPIFormats = [
        'code' => null'name' => null'account_id' => 'uuid''type' => null'bank_account_number' => null'status' => null'description' => null'bank_account_type' => null'currency_code' => null'tax_type' => null'enable_payments_to_account' => null'show_in_expense_claims' => null'class' => null'system_account' => null'reporting_code' => null'reporting_code_name' => null'has_attachments' => null'updated_date_utc' => null'add_to_watchlist' => null'validation_errors' => null
    ];
    ...
    protected static $setters = [
        'code' => 'setCode''name' => 'setName''account_id' => 'setAccountId''type' => 'setType''bank_account_number' => 'setBankAccountNumber''status' => 'setStatus''description' => 'setDescription''bank_account_type' => 'setBankAccountType''currency_code' => 'setCurrencyCode''tax_type' => 'setTaxType''enable_payments_to_account' => 'setEnablePaymentsToAccount''show_in_expense_claims' => 'setShowInExpenseClaims''class' => 'setClass''system_account' => 'setSystemAccount''reporting_code' => 'setReportingCode''reporting_code_name' => 'setReportingCodeName''has_attachments' => 'setHasAttachments''updated_date_utc' => 'setUpdatedDateUtc''add_to_watchlist' => 'setAddToWatchlist''validation_errors' => 'setValidationErrors'
    ];
    ...
    protected static $getters = [
        'code' => 'getCode''name' => 'getName''account_id' => 'getAccountId''type' => 'getType''bank_account_number' => 'getBankAccountNumber''status' => 'getStatus''description' => 'getDescription''bank_account_type' => 'getBankAccountType''currency_code' => 'getCurrencyCode''tax_type' => 'getTaxType''enable_payments_to_account' => 'getEnablePaymentsToAccount''show_in_expense_claims' => 'getShowInExpenseClaims''class' => 'getClass''system_account' => 'getSystemAccount''reporting_code' => 'getReportingCode''reporting_code_name' => 'getReportingCodeName''has_attachments' => 'getHasAttachments''updated_date_utc' => 'getUpdatedDateUtc''add_to_watchlist' => 'getAddToWatchlist''validation_errors' => 'getValidationErrors'
    ];

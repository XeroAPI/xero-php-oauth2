...
class LinkedTransaction implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'source_transaction_id' => 'string''source_line_item_id' => 'string''contact_id' => 'string''target_transaction_id' => 'string''target_line_item_id' => 'string''linked_transaction_id' => 'string''status' => 'string''type' => 'string''updated_date_utc' => 'string''source_transaction_type_code' => 'string''validation_errors' => '\XeroAPI\XeroPHP\Models\Accounting\ValidationError[]'
    ];
    ...
    protected static $openAPIFormats = [
        'source_transaction_id' => 'uuid''source_line_item_id' => 'uuid''contact_id' => 'uuid''target_transaction_id' => 'uuid''target_line_item_id' => 'uuid''linked_transaction_id' => 'uuid''status' => null'type' => null'updated_date_utc' => null'source_transaction_type_code' => null'validation_errors' => null
    ];
    ...
    protected static $attributeMap = [
        'source_transaction_id' => 'SourceTransactionID''source_line_item_id' => 'SourceLineItemID''contact_id' => 'ContactID''target_transaction_id' => 'TargetTransactionID''target_line_item_id' => 'TargetLineItemID''linked_transaction_id' => 'LinkedTransactionID''status' => 'Status''type' => 'Type''updated_date_utc' => 'UpdatedDateUTC''source_transaction_type_code' => 'SourceTransactionTypeCode''validation_errors' => 'ValidationErrors'
    ];
    ...
    protected static $setters = [
        'source_transaction_id' => 'setSourceTransactionId''source_line_item_id' => 'setSourceLineItemId''contact_id' => 'setContactId''target_transaction_id' => 'setTargetTransactionId''target_line_item_id' => 'setTargetLineItemId''linked_transaction_id' => 'setLinkedTransactionId''status' => 'setStatus''type' => 'setType''updated_date_utc' => 'setUpdatedDateUtc''source_transaction_type_code' => 'setSourceTransactionTypeCode''validation_errors' => 'setValidationErrors'
    ];
    ...
    protected static $getters = [
        'source_transaction_id' => 'getSourceTransactionId''source_line_item_id' => 'getSourceLineItemId''contact_id' => 'getContactId''target_transaction_id' => 'getTargetTransactionId''target_line_item_id' => 'getTargetLineItemId''linked_transaction_id' => 'getLinkedTransactionId''status' => 'getStatus''type' => 'getType''updated_date_utc' => 'getUpdatedDateUtc''source_transaction_type_code' => 'getSourceTransactionTypeCode''validation_errors' => 'getValidationErrors'
    ];

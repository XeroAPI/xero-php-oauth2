...
class BankTransfer implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'from_bank_account' => '\XeroAPI\XeroPHP\Models\Accounting\Account''to_bank_account' => '\XeroAPI\XeroPHP\Models\Accounting\Account''amount' => 'double''date' => 'string''bank_transfer_id' => 'string''currency_rate' => 'double''from_bank_transaction_id' => 'string''to_bank_transaction_id' => 'string''from_is_reconciled' => 'bool''to_is_reconciled' => 'bool''reference' => 'string''has_attachments' => 'bool''created_date_utc' => 'string''validation_errors' => '\XeroAPI\XeroPHP\Models\Accounting\ValidationError[]'
    ];
    ...
    protected static $openAPIFormats = [
        'from_bank_account' => null'to_bank_account' => null'amount' => 'double''date' => null'bank_transfer_id' => 'uuid''currency_rate' => 'double''from_bank_transaction_id' => 'uuid''to_bank_transaction_id' => 'uuid''from_is_reconciled' => null'to_is_reconciled' => null'reference' => null'has_attachments' => null'created_date_utc' => null'validation_errors' => null
    ];
    ...
    protected static $attributeMap = [
        'from_bank_account' => 'FromBankAccount''to_bank_account' => 'ToBankAccount''amount' => 'Amount''date' => 'Date''bank_transfer_id' => 'BankTransferID''currency_rate' => 'CurrencyRate''from_bank_transaction_id' => 'FromBankTransactionID''to_bank_transaction_id' => 'ToBankTransactionID''from_is_reconciled' => 'FromIsReconciled''to_is_reconciled' => 'ToIsReconciled''reference' => 'Reference''has_attachments' => 'HasAttachments''created_date_utc' => 'CreatedDateUTC''validation_errors' => 'ValidationErrors'
    ];
    ...
    protected static $setters = [
        'from_bank_account' => 'setFromBankAccount''to_bank_account' => 'setToBankAccount''amount' => 'setAmount''date' => 'setDate''bank_transfer_id' => 'setBankTransferId''currency_rate' => 'setCurrencyRate''from_bank_transaction_id' => 'setFromBankTransactionId''to_bank_transaction_id' => 'setToBankTransactionId''from_is_reconciled' => 'setFromIsReconciled''to_is_reconciled' => 'setToIsReconciled''reference' => 'setReference''has_attachments' => 'setHasAttachments''created_date_utc' => 'setCreatedDateUtc''validation_errors' => 'setValidationErrors'
    ];
    ...
    protected static $getters = [
        'from_bank_account' => 'getFromBankAccount''to_bank_account' => 'getToBankAccount''amount' => 'getAmount''date' => 'getDate''bank_transfer_id' => 'getBankTransferId''currency_rate' => 'getCurrencyRate''from_bank_transaction_id' => 'getFromBankTransactionId''to_bank_transaction_id' => 'getToBankTransactionId''from_is_reconciled' => 'getFromIsReconciled''to_is_reconciled' => 'getToIsReconciled''reference' => 'getReference''has_attachments' => 'getHasAttachments''created_date_utc' => 'getCreatedDateUtc''validation_errors' => 'getValidationErrors'
    ];

...
class BudgetBalance implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'period' => 'string''amount' => 'double''unit_amount' => 'double''notes' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        'period' => null'amount' => 'double''unit_amount' => 'double''notes' => null
    ];
    ...
    protected static $attributeMap = [
        'period' => 'Period''amount' => 'Amount''unit_amount' => 'UnitAmount''notes' => 'Notes'
    ];
    ...
    protected static $setters = [
        'period' => 'setPeriod''amount' => 'setAmount''unit_amount' => 'setUnitAmount''notes' => 'setNotes'
    ];
    ...
    protected static $getters = [
        'period' => 'getPeriod''amount' => 'getAmount''unit_amount' => 'getUnitAmount''notes' => 'getNotes'
    ];

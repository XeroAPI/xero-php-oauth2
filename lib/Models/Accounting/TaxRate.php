...
class TaxRate implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPIFormats = [
        'name' => null'tax_type' => null'tax_components' => null'status' => null'report_tax_type' => null'can_apply_to_assets' => null'can_apply_to_equity' => null'can_apply_to_expenses' => null'can_apply_to_liabilities' => null'can_apply_to_revenue' => null'display_tax_rate' => 'double''effective_rate' => 'double'
    ];
    ...
    protected static $attributeMap = [
        'name' => 'Name''tax_type' => 'TaxType''tax_components' => 'TaxComponents''status' => 'Status''report_tax_type' => 'ReportTaxType''can_apply_to_assets' => 'CanApplyToAssets''can_apply_to_equity' => 'CanApplyToEquity''can_apply_to_expenses' => 'CanApplyToExpenses''can_apply_to_liabilities' => 'CanApplyToLiabilities''can_apply_to_revenue' => 'CanApplyToRevenue''display_tax_rate' => 'DisplayTaxRate''effective_rate' => 'EffectiveRate'
    ];
    ...
    protected static $setters = [
        'name' => 'setName''tax_type' => 'setTaxType''tax_components' => 'setTaxComponents''status' => 'setStatus''report_tax_type' => 'setReportTaxType''can_apply_to_assets' => 'setCanApplyToAssets''can_apply_to_equity' => 'setCanApplyToEquity''can_apply_to_expenses' => 'setCanApplyToExpenses''can_apply_to_liabilities' => 'setCanApplyToLiabilities''can_apply_to_revenue' => 'setCanApplyToRevenue''display_tax_rate' => 'setDisplayTaxRate''effective_rate' => 'setEffectiveRate'
    ];
    ...
    protected static $getters = [
        'name' => 'getName''tax_type' => 'getTaxType''tax_components' => 'getTaxComponents''status' => 'getStatus''report_tax_type' => 'getReportTaxType''can_apply_to_assets' => 'getCanApplyToAssets''can_apply_to_equity' => 'getCanApplyToEquity''can_apply_to_expenses' => 'getCanApplyToExpenses''can_apply_to_liabilities' => 'getCanApplyToLiabilities''can_apply_to_revenue' => 'getCanApplyToRevenue''display_tax_rate' => 'getDisplayTaxRate''effective_rate' => 'getEffectiveRate'
    ];

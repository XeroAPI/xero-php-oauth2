...
class LineItem implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'line_item_id' => 'string''description' => 'string''quantity' => 'double''unit_amount' => 'double''item_code' => 'string''account_code' => 'string''account_id' => 'string''tax_type' => 'string''tax_amount' => 'double''item' => '\XeroAPI\XeroPHP\Models\Accounting\LineItemItem''line_amount' => 'double''tracking' => '\XeroAPI\XeroPHP\Models\Accounting\LineItemTracking[]''discount_rate' => 'double''discount_amount' => 'double''repeating_invoice_id' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        'line_item_id' => 'uuid''description' => null'quantity' => 'double''unit_amount' => 'double''item_code' => null'account_code' => null'account_id' => 'uuid''tax_type' => null'tax_amount' => 'double''item' => null'line_amount' => 'double''tracking' => null'discount_rate' => 'double''discount_amount' => 'double''repeating_invoice_id' => 'uuid'
    ];
    ...
    protected static $attributeMap = [
        'line_item_id' => 'LineItemID''description' => 'Description''quantity' => 'Quantity''unit_amount' => 'UnitAmount''item_code' => 'ItemCode''account_code' => 'AccountCode''account_id' => 'AccountID''tax_type' => 'TaxType''tax_amount' => 'TaxAmount''item' => 'Item''line_amount' => 'LineAmount''tracking' => 'Tracking''discount_rate' => 'DiscountRate''discount_amount' => 'DiscountAmount''repeating_invoice_id' => 'RepeatingInvoiceID'
    ];
    ...
    protected static $setters = [
        'line_item_id' => 'setLineItemId''description' => 'setDescription''quantity' => 'setQuantity''unit_amount' => 'setUnitAmount''item_code' => 'setItemCode''account_code' => 'setAccountCode''account_id' => 'setAccountId''tax_type' => 'setTaxType''tax_amount' => 'setTaxAmount''item' => 'setItem''line_amount' => 'setLineAmount''tracking' => 'setTracking''discount_rate' => 'setDiscountRate''discount_amount' => 'setDiscountAmount''repeating_invoice_id' => 'setRepeatingInvoiceId'
    ];
    ...
    protected static $getters = [
        'line_item_id' => 'getLineItemId''description' => 'getDescription''quantity' => 'getQuantity''unit_amount' => 'getUnitAmount''item_code' => 'getItemCode''account_code' => 'getAccountCode''account_id' => 'getAccountId''tax_type' => 'getTaxType''tax_amount' => 'getTaxAmount''item' => 'getItem''line_amount' => 'getLineAmount''tracking' => 'getTracking''discount_rate' => 'getDiscountRate''discount_amount' => 'getDiscountAmount''repeating_invoice_id' => 'getRepeatingInvoiceId'
    ];

...
class JournalLine implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'journal_line_id' => 'string''account_id' => 'string''account_code' => 'string''account_type' => '\XeroAPI\XeroPHP\Models\Accounting\AccountType''account_name' => 'string''description' => 'string''net_amount' => 'double''gross_amount' => 'double''tax_amount' => 'double''tax_type' => 'string''tax_name' => 'string''tracking_categories' => '\XeroAPI\XeroPHP\Models\Accounting\TrackingCategory[]'
    ];
    ...
    protected static $openAPIFormats = [
        'journal_line_id' => 'uuid''account_id' => 'uuid''account_code' => null'account_type' => null'account_name' => null'description' => null'net_amount' => 'double''gross_amount' => 'double''tax_amount' => 'double''tax_type' => null'tax_name' => null'tracking_categories' => null
    ];
    ...
    protected static $attributeMap = [
        'journal_line_id' => 'JournalLineID''account_id' => 'AccountID''account_code' => 'AccountCode''account_type' => 'AccountType''account_name' => 'AccountName''description' => 'Description''net_amount' => 'NetAmount''gross_amount' => 'GrossAmount''tax_amount' => 'TaxAmount''tax_type' => 'TaxType''tax_name' => 'TaxName''tracking_categories' => 'TrackingCategories'
    ];
    ...
    protected static $setters = [
        'journal_line_id' => 'setJournalLineId''account_id' => 'setAccountId''account_code' => 'setAccountCode''account_type' => 'setAccountType''account_name' => 'setAccountName''description' => 'setDescription''net_amount' => 'setNetAmount''gross_amount' => 'setGrossAmount''tax_amount' => 'setTaxAmount''tax_type' => 'setTaxType''tax_name' => 'setTaxName''tracking_categories' => 'setTrackingCategories'
    ];
    ...
    protected static $getters = [
        'journal_line_id' => 'getJournalLineId''account_id' => 'getAccountId''account_code' => 'getAccountCode''account_type' => 'getAccountType''account_name' => 'getAccountName''description' => 'getDescription''net_amount' => 'getNetAmount''gross_amount' => 'getGrossAmount''tax_amount' => 'getTaxAmount''tax_type' => 'getTaxType''tax_name' => 'getTaxName''tracking_categories' => 'getTrackingCategories'
    ];

...
class BatchPayment implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'account' => '\XeroAPI\XeroPHP\Models\Accounting\Account''reference' => 'string''particulars' => 'string''code' => 'string''details' => 'string''narrative' => 'string''batch_payment_id' => 'string''date_string' => 'string''date' => 'string''amount' => 'double''payments' => '\XeroAPI\XeroPHP\Models\Accounting\Payment[]''type' => 'string''status' => 'string''total_amount' => 'string''updated_date_utc' => 'string''is_reconciled' => 'string''validation_errors' => '\XeroAPI\XeroPHP\Models\Accounting\ValidationError[]'
    ];
    ...
    protected static $openAPIFormats = [
        'account' => null'reference' => null'particulars' => null'code' => null'details' => null'narrative' => null'batch_payment_id' => 'uuid''date_string' => null'date' => null'amount' => 'double''payments' => null'type' => null'status' => null'total_amount' => null'updated_date_utc' => null'is_reconciled' => null'validation_errors' => null
    ];
    ...
    protected static $attributeMap = [
        'account' => 'Account''reference' => 'Reference''particulars' => 'Particulars''code' => 'Code''details' => 'Details''narrative' => 'Narrative''batch_payment_id' => 'BatchPaymentID''date_string' => 'DateString''date' => 'Date''amount' => 'Amount''payments' => 'Payments''type' => 'Type''status' => 'Status''total_amount' => 'TotalAmount''updated_date_utc' => 'UpdatedDateUTC''is_reconciled' => 'IsReconciled''validation_errors' => 'ValidationErrors'
    ];
    ...
    protected static $setters = [
        'account' => 'setAccount''reference' => 'setReference''particulars' => 'setParticulars''code' => 'setCode''details' => 'setDetails''narrative' => 'setNarrative''batch_payment_id' => 'setBatchPaymentId''date_string' => 'setDateString''date' => 'setDate''amount' => 'setAmount''payments' => 'setPayments''type' => 'setType''status' => 'setStatus''total_amount' => 'setTotalAmount''updated_date_utc' => 'setUpdatedDateUtc''is_reconciled' => 'setIsReconciled''validation_errors' => 'setValidationErrors'
    ];
    ...
    protected static $getters = [
        'account' => 'getAccount''reference' => 'getReference''particulars' => 'getParticulars''code' => 'getCode''details' => 'getDetails''narrative' => 'getNarrative''batch_payment_id' => 'getBatchPaymentId''date_string' => 'getDateString''date' => 'getDate''amount' => 'getAmount''payments' => 'getPayments''type' => 'getType''status' => 'getStatus''total_amount' => 'getTotalAmount''updated_date_utc' => 'getUpdatedDateUtc''is_reconciled' => 'getIsReconciled''validation_errors' => 'getValidationErrors'
    ];

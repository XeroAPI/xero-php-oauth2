...
class RepeatingInvoice implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'type' => 'string''contact' => '\XeroAPI\XeroPHP\Models\Accounting\Contact''schedule' => '\XeroAPI\XeroPHP\Models\Accounting\Schedule''line_items' => '\XeroAPI\XeroPHP\Models\Accounting\LineItem[]''line_amount_types' => '\XeroAPI\XeroPHP\Models\Accounting\LineAmountTypes''reference' => 'string''branding_theme_id' => 'string''currency_code' => '\XeroAPI\XeroPHP\Models\Accounting\CurrencyCode''status' => 'string''sub_total' => 'double''total_tax' => 'double''total' => 'double''repeating_invoice_id' => 'string''id' => 'string''has_attachments' => 'bool''attachments' => '\XeroAPI\XeroPHP\Models\Accounting\Attachment[]'
    ];
    ...
    protected static $openAPIFormats = [
        'type' => null'contact' => null'schedule' => null'line_items' => null'line_amount_types' => null'reference' => null'branding_theme_id' => 'uuid''currency_code' => null'status' => null'sub_total' => 'double''total_tax' => 'double''total' => 'double''repeating_invoice_id' => 'uuid''id' => 'uuid''has_attachments' => null'attachments' => null
    ];
    ...
    protected static $attributeMap = [
        'type' => 'Type''contact' => 'Contact''schedule' => 'Schedule''line_items' => 'LineItems''line_amount_types' => 'LineAmountTypes''reference' => 'Reference''branding_theme_id' => 'BrandingThemeID''currency_code' => 'CurrencyCode''status' => 'Status''sub_total' => 'SubTotal''total_tax' => 'TotalTax''total' => 'Total''repeating_invoice_id' => 'RepeatingInvoiceID''id' => 'ID''has_attachments' => 'HasAttachments''attachments' => 'Attachments'
    ];
    ...
    protected static $setters = [
        'type' => 'setType''contact' => 'setContact''schedule' => 'setSchedule''line_items' => 'setLineItems''line_amount_types' => 'setLineAmountTypes''reference' => 'setReference''branding_theme_id' => 'setBrandingThemeId''currency_code' => 'setCurrencyCode''status' => 'setStatus''sub_total' => 'setSubTotal''total_tax' => 'setTotalTax''total' => 'setTotal''repeating_invoice_id' => 'setRepeatingInvoiceId''id' => 'setId''has_attachments' => 'setHasAttachments''attachments' => 'setAttachments'
    ];
    ...
    protected static $getters = [
        'type' => 'getType''contact' => 'getContact''schedule' => 'getSchedule''line_items' => 'getLineItems''line_amount_types' => 'getLineAmountTypes''reference' => 'getReference''branding_theme_id' => 'getBrandingThemeId''currency_code' => 'getCurrencyCode''status' => 'getStatus''sub_total' => 'getSubTotal''total_tax' => 'getTotalTax''total' => 'getTotal''repeating_invoice_id' => 'getRepeatingInvoiceId''id' => 'getId''has_attachments' => 'getHasAttachments''attachments' => 'getAttachments'
    ];

...
class Task implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'task_id' => 'string''name' => 'string''rate' => '\XeroAPI\XeroPHP\Models\Project\Amount''charge_type' => '\XeroAPI\XeroPHP\Models\Project\ChargeType''estimate_minutes' => 'double''project_id' => 'string''total_minutes' => 'double''total_amount' => '\XeroAPI\XeroPHP\Models\Project\Amount''minutes_invoiced' => 'double''minutes_to_be_invoiced' => 'double''fixed_minutes' => 'double''non_chargeable_minutes' => 'double''amount_to_be_invoiced' => '\XeroAPI\XeroPHP\Models\Project\Amount''amount_invoiced' => '\XeroAPI\XeroPHP\Models\Project\Amount''status' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        'task_id' => 'uuid''name' => null'rate' => null'charge_type' => null'estimate_minutes' => 'double''project_id' => 'uuid''total_minutes' => 'double''total_amount' => null'minutes_invoiced' => 'double''minutes_to_be_invoiced' => 'double''fixed_minutes' => 'double''non_chargeable_minutes' => 'double''amount_to_be_invoiced' => null'amount_invoiced' => null'status' => null
    ];
    ...
    protected static $attributeMap = [
        'task_id' => 'taskId''name' => 'name''rate' => 'rate''charge_type' => 'chargeType''estimate_minutes' => 'estimateMinutes''project_id' => 'projectId''total_minutes' => 'totalMinutes''total_amount' => 'totalAmount''minutes_invoiced' => 'minutesInvoiced''minutes_to_be_invoiced' => 'minutesToBeInvoiced''fixed_minutes' => 'fixedMinutes''non_chargeable_minutes' => 'nonChargeableMinutes''amount_to_be_invoiced' => 'amountToBeInvoiced''amount_invoiced' => 'amountInvoiced''status' => 'status'
    ];
    ...
    protected static $setters = [
        'task_id' => 'setTaskId''name' => 'setName''rate' => 'setRate''charge_type' => 'setChargeType''estimate_minutes' => 'setEstimateMinutes''project_id' => 'setProjectId''total_minutes' => 'setTotalMinutes''total_amount' => 'setTotalAmount''minutes_invoiced' => 'setMinutesInvoiced''minutes_to_be_invoiced' => 'setMinutesToBeInvoiced''fixed_minutes' => 'setFixedMinutes''non_chargeable_minutes' => 'setNonChargeableMinutes''amount_to_be_invoiced' => 'setAmountToBeInvoiced''amount_invoiced' => 'setAmountInvoiced''status' => 'setStatus'
    ];
    ...
    protected static $getters = [
        'task_id' => 'getTaskId''name' => 'getName''rate' => 'getRate''charge_type' => 'getChargeType''estimate_minutes' => 'getEstimateMinutes''project_id' => 'getProjectId''total_minutes' => 'getTotalMinutes''total_amount' => 'getTotalAmount''minutes_invoiced' => 'getMinutesInvoiced''minutes_to_be_invoiced' => 'getMinutesToBeInvoiced''fixed_minutes' => 'getFixedMinutes''non_chargeable_minutes' => 'getNonChargeableMinutes''amount_to_be_invoiced' => 'getAmountToBeInvoiced''amount_invoiced' => 'getAmountInvoiced''status' => 'getStatus'
    ];

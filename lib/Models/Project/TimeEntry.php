...
class TimeEntry implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'time_entry_id' => 'string''user_id' => 'string''project_id' => 'string''task_id' => 'string''date_utc' => '\DateTime''date_entered_utc' => '\DateTime''duration' => 'int''description' => 'string''status' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        'time_entry_id' => 'uuid''user_id' => 'uuid''project_id' => 'uuid''task_id' => 'uuid''date_utc' => 'date-time''date_entered_utc' => 'date-time''duration' => null'description' => null'status' => null
    ];
    ...
    protected static $attributeMap = [
        'time_entry_id' => 'timeEntryId''user_id' => 'userId''project_id' => 'projectId''task_id' => 'taskId''date_utc' => 'dateUtc''date_entered_utc' => 'dateEnteredUtc''duration' => 'duration''description' => 'description''status' => 'status'
    ];
    ...
    protected static $setters = [
        'time_entry_id' => 'setTimeEntryId''user_id' => 'setUserId''project_id' => 'setProjectId''task_id' => 'setTaskId''date_utc' => 'setDateUtc''date_entered_utc' => 'setDateEnteredUtc''duration' => 'setDuration''description' => 'setDescription''status' => 'setStatus'
    ];
    ...
    protected static $getters = [
        'time_entry_id' => 'getTimeEntryId''user_id' => 'getUserId''project_id' => 'getProjectId''task_id' => 'getTaskId''date_utc' => 'getDateUtc''date_entered_utc' => 'getDateEnteredUtc''duration' => 'getDuration''description' => 'getDescription''status' => 'getStatus'
    ];

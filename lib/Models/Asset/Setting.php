...
class Setting implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'asset_number_prefix' => 'string''asset_number_sequence' => 'string''asset_start_date' => '\DateTime''last_depreciation_date' => '\DateTime''default_gain_on_disposal_account_id' => 'string''default_loss_on_disposal_account_id' => 'string''default_capital_gain_on_disposal_account_id' => 'string''opt_in_for_tax' => 'bool'
    ];
    ...
    protected static $openAPIFormats = [
        'asset_number_prefix' => null'asset_number_sequence' => null'asset_start_date' => 'date''last_depreciation_date' => 'date''default_gain_on_disposal_account_id' => 'uuid''default_loss_on_disposal_account_id' => 'uuid''default_capital_gain_on_disposal_account_id' => 'uuid''opt_in_for_tax' => null
    ];
    ...
    protected static $setters = [
        'asset_number_prefix' => 'setAssetNumberPrefix''asset_number_sequence' => 'setAssetNumberSequence''asset_start_date' => 'setAssetStartDate''last_depreciation_date' => 'setLastDepreciationDate''default_gain_on_disposal_account_id' => 'setDefaultGainOnDisposalAccountId''default_loss_on_disposal_account_id' => 'setDefaultLossOnDisposalAccountId''default_capital_gain_on_disposal_account_id' => 'setDefaultCapitalGainOnDisposalAccountId''opt_in_for_tax' => 'setOptInForTax'
    ];
    ...
    protected static $getters = [
        'asset_number_prefix' => 'getAssetNumberPrefix''asset_number_sequence' => 'getAssetNumberSequence''asset_start_date' => 'getAssetStartDate''last_depreciation_date' => 'getLastDepreciationDate''default_gain_on_disposal_account_id' => 'getDefaultGainOnDisposalAccountId''default_loss_on_disposal_account_id' => 'getDefaultLossOnDisposalAccountId''default_capital_gain_on_disposal_account_id' => 'getDefaultCapitalGainOnDisposalAccountId''opt_in_for_tax' => 'getOptInForTax'
    ];

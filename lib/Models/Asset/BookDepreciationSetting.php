...
class BookDepreciationSetting implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'depreciation_method' => 'string''averaging_method' => 'string''depreciation_rate' => 'double''effective_life_years' => 'int''depreciation_calculation_method' => 'string''depreciable_object_id' => 'string''depreciable_object_type' => 'string''book_effective_date_of_change_id' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        'depreciation_method' => null'averaging_method' => null'depreciation_rate' => 'double''effective_life_years' => null'depreciation_calculation_method' => null'depreciable_object_id' => 'uuid''depreciable_object_type' => null'book_effective_date_of_change_id' => 'uuid'
    ];
    ...
    protected static $attributeMap = [
        'depreciation_method' => 'depreciationMethod''averaging_method' => 'averagingMethod''depreciation_rate' => 'depreciationRate''effective_life_years' => 'effectiveLifeYears''depreciation_calculation_method' => 'depreciationCalculationMethod''depreciable_object_id' => 'depreciableObjectId''depreciable_object_type' => 'depreciableObjectType''book_effective_date_of_change_id' => 'bookEffectiveDateOfChangeId'
    ];
    ...
    protected static $setters = [
        'depreciation_method' => 'setDepreciationMethod''averaging_method' => 'setAveragingMethod''depreciation_rate' => 'setDepreciationRate''effective_life_years' => 'setEffectiveLifeYears''depreciation_calculation_method' => 'setDepreciationCalculationMethod''depreciable_object_id' => 'setDepreciableObjectId''depreciable_object_type' => 'setDepreciableObjectType''book_effective_date_of_change_id' => 'setBookEffectiveDateOfChangeId'
    ];
    ...
    protected static $getters = [
        'depreciation_method' => 'getDepreciationMethod''averaging_method' => 'getAveragingMethod''depreciation_rate' => 'getDepreciationRate''effective_life_years' => 'getEffectiveLifeYears''depreciation_calculation_method' => 'getDepreciationCalculationMethod''depreciable_object_id' => 'getDepreciableObjectId''depreciable_object_type' => 'getDepreciableObjectType''book_effective_date_of_change_id' => 'getBookEffectiveDateOfChangeId'
    ];

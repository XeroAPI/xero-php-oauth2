...
class BookDepreciationDetail implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'current_capital_gain' => 'double''current_gain_loss' => 'double''depreciation_start_date' => '\DateTime''cost_limit' => 'double''residual_value' => 'double''prior_accum_depreciation_amount' => 'double''current_accum_depreciation_amount' => 'double'
    ];
    ...
    protected static $openAPIFormats = [
        'current_capital_gain' => 'double''current_gain_loss' => 'double''depreciation_start_date' => 'date''cost_limit' => 'double''residual_value' => 'double''prior_accum_depreciation_amount' => 'double''current_accum_depreciation_amount' => 'double'
    ];
    ...
    protected static $attributeMap = [
        'current_capital_gain' => 'currentCapitalGain''current_gain_loss' => 'currentGainLoss''depreciation_start_date' => 'depreciationStartDate''cost_limit' => 'costLimit''residual_value' => 'residualValue''prior_accum_depreciation_amount' => 'priorAccumDepreciationAmount''current_accum_depreciation_amount' => 'currentAccumDepreciationAmount'
    ];
    ...
    protected static $setters = [
        'current_capital_gain' => 'setCurrentCapitalGain''current_gain_loss' => 'setCurrentGainLoss''depreciation_start_date' => 'setDepreciationStartDate''cost_limit' => 'setCostLimit''residual_value' => 'setResidualValue''prior_accum_depreciation_amount' => 'setPriorAccumDepreciationAmount''current_accum_depreciation_amount' => 'setCurrentAccumDepreciationAmount'
    ];
    ...
    protected static $getters = [
        'current_capital_gain' => 'getCurrentCapitalGain''current_gain_loss' => 'getCurrentGainLoss''depreciation_start_date' => 'getDepreciationStartDate''cost_limit' => 'getCostLimit''residual_value' => 'getResidualValue''prior_accum_depreciation_amount' => 'getPriorAccumDepreciationAmount''current_accum_depreciation_amount' => 'getCurrentAccumDepreciationAmount'
    ];

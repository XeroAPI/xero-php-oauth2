...
class AccessToken implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'id_token' => 'string''access_token' => 'string''expires_in' => 'int''token_type' => 'string''refresh_token' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        'id_token' => null'access_token' => null'expires_in' => 'int64''token_type' => null'refresh_token' => null
    ];
    ...
    protected static $attributeMap = [
        'id_token' => 'id_token''access_token' => 'access_token''expires_in' => 'expires_in''token_type' => 'token_type''refresh_token' => 'refresh_token'
    ];
    ...
    protected static $setters = [
        'id_token' => 'setIdToken''access_token' => 'setAccessToken''expires_in' => 'setExpiresIn''token_type' => 'setTokenType''refresh_token' => 'setRefreshToken'
    ];
    ...
    protected static $getters = [
        'id_token' => 'getIdToken''access_token' => 'getAccessToken''expires_in' => 'getExpiresIn''token_type' => 'getTokenType''refresh_token' => 'getRefreshToken'
    ];

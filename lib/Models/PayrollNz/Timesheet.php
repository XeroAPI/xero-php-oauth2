...
class Timesheet implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'timesheet_id' => 'string''payroll_calendar_id' => 'string''employee_id' => 'string''start_date' => '\DateTime''end_date' => '\DateTime''status' => 'string''total_hours' => 'double''updated_date_utc' => '\DateTime''timesheet_lines' => '\XeroAPI\XeroPHP\Models\PayrollNz\TimesheetLine[]'
    ];
    ...
    protected static $openAPIFormats = [
        'timesheet_id' => 'uuid''payroll_calendar_id' => 'uuid''employee_id' => 'uuid''start_date' => 'date''end_date' => 'date''status' => null'total_hours' => 'double''updated_date_utc' => 'date-time''timesheet_lines' => null
    ];
    ...
    protected static $attributeMap = [
        'timesheet_id' => 'timesheetID''payroll_calendar_id' => 'payrollCalendarID''employee_id' => 'employeeID''start_date' => 'startDate''end_date' => 'endDate''status' => 'status''total_hours' => 'totalHours''updated_date_utc' => 'updatedDateUTC''timesheet_lines' => 'timesheetLines'
    ];
    ...
    protected static $setters = [
        'timesheet_id' => 'setTimesheetId''payroll_calendar_id' => 'setPayrollCalendarId''employee_id' => 'setEmployeeId''start_date' => 'setStartDate''end_date' => 'setEndDate''status' => 'setStatus''total_hours' => 'setTotalHours''updated_date_utc' => 'setUpdatedDateUtc''timesheet_lines' => 'setTimesheetLines'
    ];
    ...
    protected static $getters = [
        'timesheet_id' => 'getTimesheetId''payroll_calendar_id' => 'getPayrollCalendarId''employee_id' => 'getEmployeeId''start_date' => 'getStartDate''end_date' => 'getEndDate''status' => 'getStatus''total_hours' => 'getTotalHours''updated_date_utc' => 'getUpdatedDateUtc''timesheet_lines' => 'getTimesheetLines'
    ];

...
class Benefit implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'id' => 'string''name' => 'string''category' => 'string''liability_account_id' => 'string''expense_account_id' => 'string''calculation_type_nz' => 'string''standard_amount' => 'double''percentage' => 'double''company_max' => 'double''current_record' => 'bool'
    ];
    ...
    protected static $openAPIFormats = [
        'id' => 'uuid''name' => null'category' => null'liability_account_id' => 'uuid''expense_account_id' => 'uuid''calculation_type_nz' => null'standard_amount' => 'double''percentage' => 'double''company_max' => 'double''current_record' => null
    ];
    ...
    protected static $attributeMap = [
        'id' => 'id''name' => 'name''category' => 'category''liability_account_id' => 'liabilityAccountId''expense_account_id' => 'expenseAccountId''calculation_type_nz' => 'calculationTypeNZ''standard_amount' => 'standardAmount''percentage' => 'percentage''company_max' => 'companyMax''current_record' => 'currentRecord'
    ];
    ...
    protected static $setters = [
        'id' => 'setId''name' => 'setName''category' => 'setCategory''liability_account_id' => 'setLiabilityAccountId''expense_account_id' => 'setExpenseAccountId''calculation_type_nz' => 'setCalculationTypeNz''standard_amount' => 'setStandardAmount''percentage' => 'setPercentage''company_max' => 'setCompanyMax''current_record' => 'setCurrentRecord'
    ];
    ...
    protected static $getters = [
        'id' => 'getId''name' => 'getName''category' => 'getCategory''liability_account_id' => 'getLiabilityAccountId''expense_account_id' => 'getExpenseAccountId''calculation_type_nz' => 'getCalculationTypeNz''standard_amount' => 'getStandardAmount''percentage' => 'getPercentage''company_max' => 'getCompanyMax''current_record' => 'getCurrentRecord'
    ];

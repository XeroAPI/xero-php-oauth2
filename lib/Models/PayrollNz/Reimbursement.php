...
class Reimbursement implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'reimbursement_id' => 'string''name' => 'string''account_id' => 'string''current_record' => 'bool''reimbursement_category' => 'string''calculation_type' => 'string''standard_amount' => 'string''standard_type_of_units' => 'string''standard_rate_per_unit' => 'double'
    ];
    ...
    protected static $openAPIFormats = [
        'reimbursement_id' => 'uuid''name' => null'account_id' => 'uuid''current_record' => null'reimbursement_category' => null'calculation_type' => null'standard_amount' => null'standard_type_of_units' => null'standard_rate_per_unit' => 'double'
    ];
    ...
    protected static $attributeMap = [
        'reimbursement_id' => 'reimbursementID''name' => 'name''account_id' => 'accountID''current_record' => 'currentRecord''reimbursement_category' => 'reimbursementCategory''calculation_type' => 'calculationType''standard_amount' => 'standardAmount''standard_type_of_units' => 'standardTypeOfUnits''standard_rate_per_unit' => 'standardRatePerUnit'
    ];
    ...
    protected static $setters = [
        'reimbursement_id' => 'setReimbursementId''name' => 'setName''account_id' => 'setAccountId''current_record' => 'setCurrentRecord''reimbursement_category' => 'setReimbursementCategory''calculation_type' => 'setCalculationType''standard_amount' => 'setStandardAmount''standard_type_of_units' => 'setStandardTypeOfUnits''standard_rate_per_unit' => 'setStandardRatePerUnit'
    ];
    ...
    protected static $getters = [
        'reimbursement_id' => 'getReimbursementId''name' => 'getName''account_id' => 'getAccountId''current_record' => 'getCurrentRecord''reimbursement_category' => 'getReimbursementCategory''calculation_type' => 'getCalculationType''standard_amount' => 'getStandardAmount''standard_type_of_units' => 'getStandardTypeOfUnits''standard_rate_per_unit' => 'getStandardRatePerUnit'
    ];

...
class EmployeeLeaveSetup implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'include_holiday_pay' => 'bool''holiday_pay_opening_balance' => 'double''annual_leave_opening_balance' => 'double''negative_annual_leave_balance_paid_amount' => 'double''sick_leave_hours_to_accrue_annually' => 'double''sick_leave_maximum_hours_to_accrue' => 'double''sick_leave_opening_balance' => 'double'
    ];
    ...
    protected static $openAPIFormats = [
        'include_holiday_pay' => null'holiday_pay_opening_balance' => 'double''annual_leave_opening_balance' => 'double''negative_annual_leave_balance_paid_amount' => 'double''sick_leave_hours_to_accrue_annually' => 'double''sick_leave_maximum_hours_to_accrue' => 'double''sick_leave_opening_balance' => 'double'
    ];
    ...
    protected static $attributeMap = [
        'include_holiday_pay' => 'includeHolidayPay''holiday_pay_opening_balance' => 'holidayPayOpeningBalance''annual_leave_opening_balance' => 'annualLeaveOpeningBalance''negative_annual_leave_balance_paid_amount' => 'negativeAnnualLeaveBalancePaidAmount''sick_leave_hours_to_accrue_annually' => 'sickLeaveHoursToAccrueAnnually''sick_leave_maximum_hours_to_accrue' => 'sickLeaveMaximumHoursToAccrue''sick_leave_opening_balance' => 'sickLeaveOpeningBalance'
    ];
    ...
    protected static $setters = [
        'include_holiday_pay' => 'setIncludeHolidayPay''holiday_pay_opening_balance' => 'setHolidayPayOpeningBalance''annual_leave_opening_balance' => 'setAnnualLeaveOpeningBalance''negative_annual_leave_balance_paid_amount' => 'setNegativeAnnualLeaveBalancePaidAmount''sick_leave_hours_to_accrue_annually' => 'setSickLeaveHoursToAccrueAnnually''sick_leave_maximum_hours_to_accrue' => 'setSickLeaveMaximumHoursToAccrue''sick_leave_opening_balance' => 'setSickLeaveOpeningBalance'
    ];
    ...
    protected static $getters = [
        'include_holiday_pay' => 'getIncludeHolidayPay''holiday_pay_opening_balance' => 'getHolidayPayOpeningBalance''annual_leave_opening_balance' => 'getAnnualLeaveOpeningBalance''negative_annual_leave_balance_paid_amount' => 'getNegativeAnnualLeaveBalancePaidAmount''sick_leave_hours_to_accrue_annually' => 'getSickLeaveHoursToAccrueAnnually''sick_leave_maximum_hours_to_accrue' => 'getSickLeaveMaximumHoursToAccrue''sick_leave_opening_balance' => 'getSickLeaveOpeningBalance'
    ];

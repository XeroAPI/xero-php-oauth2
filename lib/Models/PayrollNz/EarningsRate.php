...
class EarningsRate implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'earnings_rate_id' => 'string''name' => 'string''earnings_type' => 'string''rate_type' => 'string''type_of_units' => 'string''current_record' => 'bool''expense_account_id' => 'string''rate_per_unit' => 'double''multiple_of_ordinary_earnings_rate' => 'double''fixed_amount' => 'double'
    ];
    ...
    protected static $openAPIFormats = [
        'earnings_rate_id' => 'uuid''name' => null'earnings_type' => null'rate_type' => null'type_of_units' => null'current_record' => null'expense_account_id' => 'uuid''rate_per_unit' => 'double''multiple_of_ordinary_earnings_rate' => 'double''fixed_amount' => 'double'
    ];
    ...
    protected static $attributeMap = [
        'earnings_rate_id' => 'earningsRateID''name' => 'name''earnings_type' => 'earningsType''rate_type' => 'rateType''type_of_units' => 'typeOfUnits''current_record' => 'currentRecord''expense_account_id' => 'expenseAccountID''rate_per_unit' => 'ratePerUnit''multiple_of_ordinary_earnings_rate' => 'multipleOfOrdinaryEarningsRate''fixed_amount' => 'fixedAmount'
    ];
    ...
    protected static $setters = [
        'earnings_rate_id' => 'setEarningsRateId''name' => 'setName''earnings_type' => 'setEarningsType''rate_type' => 'setRateType''type_of_units' => 'setTypeOfUnits''current_record' => 'setCurrentRecord''expense_account_id' => 'setExpenseAccountId''rate_per_unit' => 'setRatePerUnit''multiple_of_ordinary_earnings_rate' => 'setMultipleOfOrdinaryEarningsRate''fixed_amount' => 'setFixedAmount'
    ];
    ...
    protected static $getters = [
        'earnings_rate_id' => 'getEarningsRateId''name' => 'getName''earnings_type' => 'getEarningsType''rate_type' => 'getRateType''type_of_units' => 'getTypeOfUnits''current_record' => 'getCurrentRecord''expense_account_id' => 'getExpenseAccountId''rate_per_unit' => 'getRatePerUnit''multiple_of_ordinary_earnings_rate' => 'getMultipleOfOrdinaryEarningsRate''fixed_amount' => 'getFixedAmount'
    ];

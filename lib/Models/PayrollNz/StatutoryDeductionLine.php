...
class StatutoryDeductionLine implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'statutory_deduction_type_id' => 'string''amount' => 'double''fixed_amount' => 'double''manual_adjustment' => 'bool'
    ];
    ...
    protected static $openAPIFormats = [
        'statutory_deduction_type_id' => 'uuid''amount' => 'double''fixed_amount' => 'double''manual_adjustment' => null
    ];
    ...
    protected static $attributeMap = [
        'statutory_deduction_type_id' => 'statutoryDeductionTypeID''amount' => 'amount''fixed_amount' => 'fixedAmount''manual_adjustment' => 'manualAdjustment'
    ];
    ...
    protected static $setters = [
        'statutory_deduction_type_id' => 'setStatutoryDeductionTypeId''amount' => 'setAmount''fixed_amount' => 'setFixedAmount''manual_adjustment' => 'setManualAdjustment'
    ];
    ...
    protected static $getters = [
        'statutory_deduction_type_id' => 'getStatutoryDeductionTypeId''amount' => 'getAmount''fixed_amount' => 'getFixedAmount''manual_adjustment' => 'getManualAdjustment'
    ];

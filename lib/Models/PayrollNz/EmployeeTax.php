...
class EmployeeTax implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'ird_number' => 'string''tax_code' => '\XeroAPI\XeroPHP\Models\PayrollNz\TaxCode''special_tax_rate_percentage' => 'double''has_special_student_loan_rate' => 'bool''special_student_loan_rate_percentage' => 'double''is_eligible_for_kiwi_saver' => 'bool''esct_rate_percentage' => 'double''kiwi_saver_contributions' => 'string''kiwi_saver_employee_contribution_rate_percentage' => 'double''kiwi_saver_employer_contribution_rate_percentage' => 'double''kiwi_saver_employer_salary_sacrifice_contribution_rate_percentage' => 'double''kiwi_saver_opt_out_date' => '\DateTime''kiwi_saver_contribution_holiday_end_date' => '\DateTime''has_student_loan_balance' => 'bool''student_loan_balance' => 'double''student_loan_as_at' => '\DateTime'
    ];
    ...
    protected static $openAPIFormats = [
        'ird_number' => null'tax_code' => null'special_tax_rate_percentage' => 'double''has_special_student_loan_rate' => null'special_student_loan_rate_percentage' => 'double''is_eligible_for_kiwi_saver' => null'esct_rate_percentage' => 'double''kiwi_saver_contributions' => null'kiwi_saver_employee_contribution_rate_percentage' => 'double''kiwi_saver_employer_contribution_rate_percentage' => 'double''kiwi_saver_employer_salary_sacrifice_contribution_rate_percentage' => 'double''kiwi_saver_opt_out_date' => 'date''kiwi_saver_contribution_holiday_end_date' => 'date''has_student_loan_balance' => null'student_loan_balance' => 'double''student_loan_as_at' => 'date'
    ];
    ...
    protected static $setters = [
        'ird_number' => 'setIrdNumber''tax_code' => 'setTaxCode''special_tax_rate_percentage' => 'setSpecialTaxRatePercentage''has_special_student_loan_rate' => 'setHasSpecialStudentLoanRate''special_student_loan_rate_percentage' => 'setSpecialStudentLoanRatePercentage''is_eligible_for_kiwi_saver' => 'setIsEligibleForKiwiSaver''esct_rate_percentage' => 'setEsctRatePercentage''kiwi_saver_contributions' => 'setKiwiSaverContributions''kiwi_saver_employee_contribution_rate_percentage' => 'setKiwiSaverEmployeeContributionRatePercentage''kiwi_saver_employer_contribution_rate_percentage' => 'setKiwiSaverEmployerContributionRatePercentage''kiwi_saver_employer_salary_sacrifice_contribution_rate_percentage' => 'setKiwiSaverEmployerSalarySacrificeContributionRatePercentage''kiwi_saver_opt_out_date' => 'setKiwiSaverOptOutDate''kiwi_saver_contribution_holiday_end_date' => 'setKiwiSaverContributionHolidayEndDate''has_student_loan_balance' => 'setHasStudentLoanBalance''student_loan_balance' => 'setStudentLoanBalance''student_loan_as_at' => 'setStudentLoanAsAt'
    ];
    ...
    protected static $getters = [
        'ird_number' => 'getIrdNumber''tax_code' => 'getTaxCode''special_tax_rate_percentage' => 'getSpecialTaxRatePercentage''has_special_student_loan_rate' => 'getHasSpecialStudentLoanRate''special_student_loan_rate_percentage' => 'getSpecialStudentLoanRatePercentage''is_eligible_for_kiwi_saver' => 'getIsEligibleForKiwiSaver''esct_rate_percentage' => 'getEsctRatePercentage''kiwi_saver_contributions' => 'getKiwiSaverContributions''kiwi_saver_employee_contribution_rate_percentage' => 'getKiwiSaverEmployeeContributionRatePercentage''kiwi_saver_employer_contribution_rate_percentage' => 'getKiwiSaverEmployerContributionRatePercentage''kiwi_saver_employer_salary_sacrifice_contribution_rate_percentage' => 'getKiwiSaverEmployerSalarySacrificeContributionRatePercentage''kiwi_saver_opt_out_date' => 'getKiwiSaverOptOutDate''kiwi_saver_contribution_holiday_end_date' => 'getKiwiSaverContributionHolidayEndDate''has_student_loan_balance' => 'getHasStudentLoanBalance''student_loan_balance' => 'getStudentLoanBalance''student_loan_as_at' => 'getStudentLoanAsAt'
    ];

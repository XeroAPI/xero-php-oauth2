...
class PayRunCalendar implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'payroll_calendar_id' => 'string''name' => 'string''calendar_type' => '\XeroAPI\XeroPHP\Models\PayrollNz\CalendarType''period_start_date' => '\DateTime''period_end_date' => '\DateTime''payment_date' => '\DateTime''updated_date_utc' => '\DateTime'
    ];
    ...
    protected static $openAPIFormats = [
        'payroll_calendar_id' => 'uuid''name' => null'calendar_type' => null'period_start_date' => 'date''period_end_date' => 'date''payment_date' => 'date''updated_date_utc' => 'date-time'
    ];
    ...
    protected static $attributeMap = [
        'payroll_calendar_id' => 'payrollCalendarID''name' => 'name''calendar_type' => 'calendarType''period_start_date' => 'periodStartDate''period_end_date' => 'periodEndDate''payment_date' => 'paymentDate''updated_date_utc' => 'updatedDateUTC'
    ];
    ...
    protected static $setters = [
        'payroll_calendar_id' => 'setPayrollCalendarId''name' => 'setName''calendar_type' => 'setCalendarType''period_start_date' => 'setPeriodStartDate''period_end_date' => 'setPeriodEndDate''payment_date' => 'setPaymentDate''updated_date_utc' => 'setUpdatedDateUtc'
    ];
    ...
    protected static $getters = [
        'payroll_calendar_id' => 'getPayrollCalendarId''name' => 'getName''calendar_type' => 'getCalendarType''period_start_date' => 'getPeriodStartDate''period_end_date' => 'getPeriodEndDate''payment_date' => 'getPaymentDate''updated_date_utc' => 'getUpdatedDateUtc'
    ];

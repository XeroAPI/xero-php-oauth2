...
class LeaveType implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'leave_type_id' => 'string''name' => 'string''is_paid_leave' => 'bool''show_on_payslip' => 'bool''updated_date_utc' => '\DateTime''is_active' => 'bool'
    ];
    ...
    protected static $openAPIFormats = [
        'leave_type_id' => 'uuid''name' => null'is_paid_leave' => null'show_on_payslip' => null'updated_date_utc' => 'date-time''is_active' => null
    ];
    ...
    protected static $attributeMap = [
        'leave_type_id' => 'leaveTypeID''name' => 'name''is_paid_leave' => 'isPaidLeave''show_on_payslip' => 'showOnPayslip''updated_date_utc' => 'updatedDateUTC''is_active' => 'isActive'
    ];
    ...
    protected static $setters = [
        'leave_type_id' => 'setLeaveTypeId''name' => 'setName''is_paid_leave' => 'setIsPaidLeave''show_on_payslip' => 'setShowOnPayslip''updated_date_utc' => 'setUpdatedDateUtc''is_active' => 'setIsActive'
    ];
    ...
    protected static $getters = [
        'leave_type_id' => 'getLeaveTypeId''name' => 'getName''is_paid_leave' => 'getIsPaidLeave''show_on_payslip' => 'getShowOnPayslip''updated_date_utc' => 'getUpdatedDateUtc''is_active' => 'getIsActive'
    ];

...
class ReimbursementLine implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'reimbursement_type_id' => 'string''description' => 'string''amount' => 'double''rate_per_unit' => 'double''number_of_units' => 'double'
    ];
    ...
    protected static $openAPIFormats = [
        'reimbursement_type_id' => 'uuid''description' => null'amount' => 'double''rate_per_unit' => 'double''number_of_units' => 'double'
    ];
    ...
    protected static $attributeMap = [
        'reimbursement_type_id' => 'reimbursementTypeID''description' => 'description''amount' => 'amount''rate_per_unit' => 'ratePerUnit''number_of_units' => 'numberOfUnits'
    ];
    ...
    protected static $setters = [
        'reimbursement_type_id' => 'setReimbursementTypeId''description' => 'setDescription''amount' => 'setAmount''rate_per_unit' => 'setRatePerUnit''number_of_units' => 'setNumberOfUnits'
    ];
    ...
    protected static $getters = [
        'reimbursement_type_id' => 'getReimbursementTypeId''description' => 'getDescription''amount' => 'getAmount''rate_per_unit' => 'getRatePerUnit''number_of_units' => 'getNumberOfUnits'
    ];

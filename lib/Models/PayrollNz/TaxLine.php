...
class TaxLine implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'tax_line_id' => 'string''description' => 'string''amount' => 'double''global_tax_type_id' => 'string''manual_adjustment' => 'bool'
    ];
    ...
    protected static $openAPIFormats = [
        'tax_line_id' => 'uuid''description' => null'amount' => 'double''global_tax_type_id' => null'manual_adjustment' => null
    ];
    ...
    protected static $attributeMap = [
        'tax_line_id' => 'taxLineID''description' => 'description''amount' => 'amount''global_tax_type_id' => 'globalTaxTypeID''manual_adjustment' => 'manualAdjustment'
    ];
    ...
    protected static $setters = [
        'tax_line_id' => 'setTaxLineId''description' => 'setDescription''amount' => 'setAmount''global_tax_type_id' => 'setGlobalTaxTypeId''manual_adjustment' => 'setManualAdjustment'
    ];
    ...
    protected static $getters = [
        'tax_line_id' => 'getTaxLineId''description' => 'getDescription''amount' => 'getAmount''global_tax_type_id' => 'getGlobalTaxTypeId''manual_adjustment' => 'getManualAdjustment'
    ];

...
class SalaryAndWage implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'salary_and_wages_id' => 'string''earnings_rate_id' => 'string''number_of_units_per_week' => 'double''rate_per_unit' => 'double''number_of_units_per_day' => 'double''days_per_week' => 'double''effective_from' => '\DateTime''annual_salary' => 'double''status' => 'string''payment_type' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        'salary_and_wages_id' => 'uuid''earnings_rate_id' => 'uuid''number_of_units_per_week' => 'double''rate_per_unit' => 'double''number_of_units_per_day' => 'double''days_per_week' => 'double''effective_from' => 'date''annual_salary' => 'double''status' => null'payment_type' => null
    ];
    ...
    protected static $attributeMap = [
        'salary_and_wages_id' => 'salaryAndWagesID''earnings_rate_id' => 'earningsRateID''number_of_units_per_week' => 'numberOfUnitsPerWeek''rate_per_unit' => 'ratePerUnit''number_of_units_per_day' => 'numberOfUnitsPerDay''days_per_week' => 'daysPerWeek''effective_from' => 'effectiveFrom''annual_salary' => 'annualSalary''status' => 'status''payment_type' => 'paymentType'
    ];
    ...
    protected static $setters = [
        'salary_and_wages_id' => 'setSalaryAndWagesId''earnings_rate_id' => 'setEarningsRateId''number_of_units_per_week' => 'setNumberOfUnitsPerWeek''rate_per_unit' => 'setRatePerUnit''number_of_units_per_day' => 'setNumberOfUnitsPerDay''days_per_week' => 'setDaysPerWeek''effective_from' => 'setEffectiveFrom''annual_salary' => 'setAnnualSalary''status' => 'setStatus''payment_type' => 'setPaymentType'
    ];
    ...
    protected static $getters = [
        'salary_and_wages_id' => 'getSalaryAndWagesId''earnings_rate_id' => 'getEarningsRateId''number_of_units_per_week' => 'getNumberOfUnitsPerWeek''rate_per_unit' => 'getRatePerUnit''number_of_units_per_day' => 'getNumberOfUnitsPerDay''days_per_week' => 'getDaysPerWeek''effective_from' => 'getEffectiveFrom''annual_salary' => 'getAnnualSalary''status' => 'getStatus''payment_type' => 'getPaymentType'
    ];

...
class EmployeeLeaveType implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'leave_type_id' => 'string''schedule_of_accrual' => 'string''hours_accrued_annually' => 'double''maximum_to_accrue' => 'double''opening_balance' => 'double''rate_accrued_hourly' => 'double''percentage_of_gross_earnings' => 'double''include_holiday_pay_every_pay' => 'bool''show_annual_leave_in_advance' => 'bool''annual_leave_total_amount_paid' => 'double'
    ];
    ...
    protected static $openAPIFormats = [
        'leave_type_id' => 'uuid''schedule_of_accrual' => null'hours_accrued_annually' => 'double''maximum_to_accrue' => 'double''opening_balance' => 'double''rate_accrued_hourly' => 'double''percentage_of_gross_earnings' => 'double''include_holiday_pay_every_pay' => null'show_annual_leave_in_advance' => null'annual_leave_total_amount_paid' => 'double'
    ];
    ...
    protected static $setters = [
        'leave_type_id' => 'setLeaveTypeId''schedule_of_accrual' => 'setScheduleOfAccrual''hours_accrued_annually' => 'setHoursAccruedAnnually''maximum_to_accrue' => 'setMaximumToAccrue''opening_balance' => 'setOpeningBalance''rate_accrued_hourly' => 'setRateAccruedHourly''percentage_of_gross_earnings' => 'setPercentageOfGrossEarnings''include_holiday_pay_every_pay' => 'setIncludeHolidayPayEveryPay''show_annual_leave_in_advance' => 'setShowAnnualLeaveInAdvance''annual_leave_total_amount_paid' => 'setAnnualLeaveTotalAmountPaid'
    ];
    ...
    protected static $getters = [
        'leave_type_id' => 'getLeaveTypeId''schedule_of_accrual' => 'getScheduleOfAccrual''hours_accrued_annually' => 'getHoursAccruedAnnually''maximum_to_accrue' => 'getMaximumToAccrue''opening_balance' => 'getOpeningBalance''rate_accrued_hourly' => 'getRateAccruedHourly''percentage_of_gross_earnings' => 'getPercentageOfGrossEarnings''include_holiday_pay_every_pay' => 'getIncludeHolidayPayEveryPay''show_annual_leave_in_advance' => 'getShowAnnualLeaveInAdvance''annual_leave_total_amount_paid' => 'getAnnualLeaveTotalAmountPaid'
    ];

...
/**
 * AccountingConfiguration Class Doc Comment
 * PHP version 5
 *
 * @category Class
 * @package  XeroAPI\XeroPHP
...
class AccountingConfiguration
{
    ...
    public static function getDefaultConfiguration()
    {
        if (self::$defaultConfiguration === null) {
            self::$defaultConfiguration = new AccountingConfiguration();
        }
     ...
     *
     * @param AccountingConfiguration $config An instance of the AccountingConfiguration Object
     *
     * @return void
     */
    public static function setDefaultConfiguration(AccountingConfiguration $config)
    {

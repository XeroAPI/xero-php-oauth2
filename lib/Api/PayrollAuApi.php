...
class PayrollAuApi
{
     ...
     */
    public function approveLeaveApplication($xero_tenant_id, $leave_application_id)
    {
        list($response) = $this->approveLeaveApplicationWithHttpInfo($xero_tenant_id, $leave_application_id);
        return $response;
    }
    /**
     ...
     */
    public function approveLeaveApplicationWithHttpInfo($xero_tenant_id, $leave_application_id)
    {
        $request = $this->approveLeaveApplicationRequest($xero_tenant_id, $leave_application_id);
        try {
     ...
     */
    public function approveLeaveApplicationAsync($xero_tenant_id, $leave_application_id)
    {
        return $this->approveLeaveApplicationAsyncWithHttpInfo($xero_tenant_id, $leave_application_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Promise\PromiseInterface */
    public function approveLeaveApplicationAsyncWithHttpInfo($xero_tenant_id, $leave_application_id)
    {
        $returnType = '\XeroAPI\XeroPHP\Models\PayrollAu\LeaveApplications';
        $request = $this->approveLeaveApplicationRequest($xero_tenant_id, $leave_application_id);
        return $this->client
    ...
    protected function approveLeaveApplicationRequest($xero_tenant_id, $leave_application_id)
    {
     ...
     * @return \XeroAPI\XeroPHP\Models\PayrollAu\LeaveApplications|\XeroAPI\XeroPHP\Models\PayrollAu\APIException
     */
    public function rejectLeaveApplication($xero_tenant_id, $leave_application_id)
    {
        list($response) = $this->rejectLeaveApplicationWithHttpInfo($xero_tenant_id, $leave_application_id);
        return $response;
    }
    /**
     ...
     * @return array of \XeroAPI\XeroPHP\Models\PayrollAu\LeaveApplications|\XeroAPI\XeroPHP\Models\PayrollAu\APIException, HTTP status code, HTTP response headers (array of strings)
     */
    public function rejectLeaveApplicationWithHttpInfo($xero_tenant_id, $leave_application_id)
    {
        $request = $this->rejectLeaveApplicationRequest($xero_tenant_id, $leave_application_id);
        try {
            $options = $this->createHttpClientOption();
            try {
                $response = $this->client->send($request, $options);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function rejectLeaveApplicationAsync($xero_tenant_id, $leave_application_id)
    {
        return $this->rejectLeaveApplicationAsyncWithHttpInfo($xero_tenant_id, $leave_application_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Promise\PromiseInterface */
    public function rejectLeaveApplicationAsyncWithHttpInfo($xero_tenant_id, $leave_application_id)
    {
        $returnType = '\XeroAPI\XeroPHP\Models\PayrollAu\LeaveApplications';
        $request = $this->rejectLeaveApplicationRequest($xero_tenant_id, $leave_application_id);
        return $this->client
     ...
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request  */
    protected function rejectLeaveApplicationRequest($xero_tenant_id, $leave_application_id)
    {
        // verify the required parameter 'xero_tenant_id' is set
        if ($xero_tenant_id === null || (is_array($xero_tenant_id) && count($xero_tenant_id) === 0)) {
            throw new \InvalidArgumentException(
